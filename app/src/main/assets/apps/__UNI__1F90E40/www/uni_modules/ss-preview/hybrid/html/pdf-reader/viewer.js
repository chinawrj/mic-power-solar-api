...
([
	...
	(function(module, exports, __webpack_require__) {
		...
		var PDFViewerApplication = {
			...
			_initializeViewerComponents: function _initializeViewerComponents() {
				...
				return new Promise(function(resolve, reject) {
					...
					var eventBus = appConfig.eventBus || (0,
					_dom_events.getGlobalEventBus)();
			...
			zoomIn: function zoomIn(ticks) {
				...
				} while (--ticks > 0 && newScale < _ui_utils.MAX_SCALE);this.pdfViewer.currentScaleValue = newScale;
			},
			zoomOut: function zoomOut(ticks) {
				...
				} while (--ticks > 0 && newScale > _ui_utils.MIN_SCALE);this.pdfViewer.currentScaleValue = newScale;
			},
			get pagesCount() {
			...
			get supportsFullscreen() {
				...
				return (0,
				_pdfjsLib.shadow)(this, 'supportsFullscreen', support);
			},
			...
			get loadingBar() {
				...
				return (0,
				_pdfjsLib.shadow)(this, 'loadingBar', bar);
			},
			...
			setTitleUsingUrl: function setTitleUsingUrl(url) {
				...
				var title = (0,
				_ui_utils.getPDFFileNameFromURL)(url, '');
				if (!title) {
					try {
						title = decodeURIComponent((0,
						_pdfjsLib.getFilenameFromUrl)(url)) || url;
					} catch (ex) {
						title = url;
					}
				}
			...
			open: function open(file, args) {
				...
				var loadingTask = (0,
				_pdfjsLib.getDocument)(parameters);
			...
			download: function download() {
				...
				var filename = (0,
				_ui_utils.getPDFFileNameFromURL)(this.url);
				...
				this.pdfDocument.getData().then(function(data) {
					var blob = (0,
					_pdfjsLib.createBlob)(data, 'application/pdf');
			...
			setInitialView: function setInitialView(storedHash) {
				...
				var setRotation = function setRotation(angle) {
					if ((0,
					_ui_utils.isValidRotation)(angle)) {
		...
		{
			var HOSTED_VIEWER_ORIGINS = allowd_origins;
		...
		function webViewerInitialized() {
			...
			var params = (0,
			_ui_utils.parseQueryString)(queryString);
			...
			_createClass(PDFFindController, [{
				...
				value: function updateMatchPosition(pageIndex, matchIndex, elements, beginIdx) {
					if (this.selected.matchIdx === matchIndex && this.selected.pageIdx === pageIndex) {
						...
						(0,
						_ui_utils.scrollIntoView)(elements[beginIdx], spot, true);
					}
				}
			}, {
				key: 'nextPageMatch',
			...
			_createClass(PDFAttachmentViewer, [{
				...
				value: function _bindPdfLink(button, content, filename) {
					...
					button.onclick = function() {
						if (!blobUrl) {
							blobUrl = (0,
							_pdfjsLib.createObjectURL)(content, 'application/pdf');
						}
				...
				value: function render(_ref2) {
					...
					for (var i = 0; i < attachmentsCount; i++) {
						...
						var filename = (0,
						_pdfjsLib.removeNullCharacters)((0,
						_pdfjsLib.getFilenameFromUrl)(item.filename));
				...
				value: function open() {
					...
					Promise.all([this.overlayManager.open(this.overlayName), this._dataAvailableCapability.promise]).then(function() {
						...
						_this.pdfDocument.getMetadata().then(function(_ref2) {
							...
							freezeFieldData({
								'fileName': (0,
								_ui_utils.getPDFFileNameFromURL)(_this.url),
								'fileSize': fileSize,
								'title': info.Title,
								'author': info.Author,
							...
							var data = (0,
							_ui_utils.cloneObj)(_this.fieldData);
	...
	(function(module, exports, __webpack_require__) {
		...
		var PDFHistory = function() {
			...
			_createClass(PDFHistory, [{
				...
				value: function _tryPushCurrentPosition() {
					...
					if (temporary) {
						position = (0,
						_ui_utils.cloneObj)(this._position);
				...
				value: function _popState(_ref4) {
					...
					if (hashChanged) {
						...
						(0,
						_ui_utils.waitOnEventOrTimeout)({
							target: window,
							name: 'hashchange',
					...
					this._updateInternalState(destination, state.uid, true);
					if ((0,
					_ui_utils.isValidRotation)(destination.rotation)) {
		...
		function isDestHashesEqual(destHash, pushHash) {
			...
			var _parseQueryString = (0,
			_ui_utils.parseQueryString)(destHash)
		...
		var PDFOutlineViewer = function() {
			...
			_createClass(PDFOutlineViewer, [{
				...
				value: function _bindLink(element, item) {
					...
					if (item.url) {
						(0,
						_pdfjsLib.addLinkAttributes)(element, {
							url: item.url,
				...
				value: function render(_ref2) {
					...
					while (queue.length > 0) {
						...
						for (var i = 0, len = levelData.items.length; i < len; i++) {
							...
							_pdfjsLib.removeNullCharacters)(item.title) || DEFAULT_TITLE;
	...
	(function(module, exports, __webpack_require__) {
		...
		var PDFThumbnailViewer = function() {
			function PDFThumbnailViewer(_ref) {
				...
				this.l10n = l10n;
				this.scroll = (0,
				_ui_utils.watchScroll)(this.container, this._scrollUpdated.bind(this));
				this._resetView();
			}
			_createClass(PDFThumbnailViewer, [{
				...
				value: function _getVisibleThumbs() {
					return (0,
					_ui_utils.getVisibleElements)(this.container, this._thumbnails);
				}
			}, {
				...
				value: function scrollThumbnailIntoView(page) {
					...
					if (numVisibleThumbs > 0) {
						...
						if (page <= first || page >= last) {
							(0,
							_ui_utils.scrollIntoView)(thumbnail, {
				...
				set: function set(rotation) {
					if (!(0,
					_ui_utils.isValidRotation)(rotation)) {
		...
		var PDFViewer = function(_BaseViewer) {
			...
			_createClass(PDFViewer, [{
				...
				value: function _scrollIntoView(_ref) {
					...
					(0,
					_ui_utils.scrollIntoView)(pageDiv, pageSpot);
				}
			}, {
				...
				value: function _getVisiblePages() {
					if (!this.isInPresentationMode) {
						return (0,
						_ui_utils.getVisibleElements)(this.container, this._pages, true);
					}
				...
				get: function get() {
					return (0,
					_pdfjsLib.shadow)(this, '_setDocumentViewerElement', this.viewer);
				}
			}]);
			return PDFViewer;
	...
	(function(module, exports, __webpack_require__) {
		...
		var BaseViewer = function() {
			function BaseViewer(options) {
				...
				this.scroll = (0,
				_ui_utils.watchScroll)(this.container, this._scrollUpdate.bind(this));
		...
		var PDFPageView = function() {
			...
			_createClass(PDFPageView, [{
				...
				value: function paintOnCanvas(canvasWrapper) {
					...
					var sfx = (0,
					_ui_utils.approximateFraction)(outputScale.sx);
					var sfy = (0,
					_ui_utils.approximateFraction)(outputScale.sy);
					canvas.width = (0,
					_ui_utils.roundToDivide)(viewport.width * outputScale.sx, sfx[0]);
					canvas.height = (0,
					_ui_utils.roundToDivide)(viewport.height * outputScale.sy, sfy[0]);
					canvas.style.width = (0,
					_ui_utils.roundToDivide)(viewport.width, sfx[1]) + 'px';
					canvas.style.height = (0,
					_ui_utils.roundToDivide)(viewport.height, sfy[1]) + 'px';
		...
		var BasePreferences = function() {
			...
			_createClass(BasePreferences, [{
				...
				value: function reset() {
					...
					return this._initializedPromise.then(function() {
						_this2.prefs = (0,
						_ui_utils.cloneObj)(_this2.defaults);
		...
		var DownloadManager = function() {
			...
			_createClass(DownloadManager, [{
				...
				value: function downloadUrl(url, filename) {
					if (!(0,
					_pdfjsLib.createValidAbsoluteUrl)(url, 'http://example.com')) {
						return;
					}
				...
				value: function downloadData(data, filename, contentType) {
					...
					var blobUrl = (0,
					_pdfjsLib.createObjectURL)(data, contentType, _pdfjsLib.PDFJS.disableCreateObjectURL);

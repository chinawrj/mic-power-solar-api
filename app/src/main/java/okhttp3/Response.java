...
public final class Response implements Closeable {
    ...
    public ResponseBody peekBody(long j) throws IOException {
        ...
        Buffer bufferM1936clone = bufferedSourceSource.buffer().clone();
        if (bufferM1936clone.size() > j) {
            Buffer buffer = new Buffer();
            buffer.write(bufferM1936clone, j);
            bufferM1936clone.clear();
            bufferM1936clone = buffer;
        }
        return ResponseBody.create(this.body.contentType(), bufferM1936clone.size(), bufferM1936clone);
    }

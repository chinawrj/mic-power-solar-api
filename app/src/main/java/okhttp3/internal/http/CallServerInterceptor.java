    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (HttpMethod.permitsRequestBody(request.method()) && request.body() != null) {
            ...
            if (responseHeaders == null) {
                ...
                CountingSink countingSink = new CountingSink(httpCodecHttpStream.createRequestBody(request, request.body().getLength()));
        ...
        if (AbsoluteConst.EVENTS_CLOSE.equalsIgnoreCase(responseBuild.request().header("Connection")) || AbsoluteConst.EVENTS_CLOSE.equalsIgnoreCase(responseBuild.header("Connection"))) {
            streamAllocation.noNewStreams();
        }

...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        if (objNewInstance != null) {
            objM326constructorimpl = Result.m326constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(objNewInstance, 1));
            return (Function1) (Result.m332isFailureimpl(objM326constructorimpl) ? null : objM326constructorimpl);
        }
    ...
    public final Object[] dumpCoroutinesInfoAsJsonAndReferences() {
        ...
        String str = Operators.ARRAY_START_STR + CollectionsKt.joinToString$default(arrayList3, null, null, null, 0, null, null, 63, null) + Operators.ARRAY_END;
    ...
    public final String enhanceStackTraceWithThreadDumpAsJson(DebugCoroutineInfo info) {
        ...
        return Operators.ARRAY_START_STR + CollectionsKt.joinToString$default(arrayList, null, null, null, 0, null, null, 63, null) + Operators.ARRAY_END;
    }

    private final String toStringWithQuotes(Object obj) {
        return JSUtil.QUOTE + obj + '\"';
    }
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            DebugProbesImpl debugProbesImpl = this;
            objM326constructorimpl = Result.m326constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM326constructorimpl = Result.m326constructorimpl(ResultKt.createFailure(th));
        }
        ...
        StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) objM326constructorimpl;

...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM326constructorimpl = Result.m326constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM326constructorimpl = Result.m326constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m332isFailureimpl(objM326constructorimpl) ? null : objM326constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1900installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1900installSignalHandler$lambda1(Signal signal) {

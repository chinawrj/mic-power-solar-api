...
public abstract class CoroutineDispatcher extends AbstractCoroutineContextElement implements ContinuationInterceptor {
    ...
    public abstract void mo1923dispatch(CoroutineContext context, Runnable block);
    ...
    public String toString() {
        return DebugStringsKt.getClassSimpleName(this) + TemplateDom.SEPARATOR + DebugStringsKt.getHexAddress(this);
    }
}

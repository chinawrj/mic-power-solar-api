...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM326constructorimpl = Result.m326constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM326constructorimpl = Result.m326constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m332isFailureimpl(objM326constructorimpl)) {
                objM326constructorimpl = null;
            }
            return (E) objM326constructorimpl;
        }
            ...
            return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$4
                ...
                public final Throwable invoke(Throwable th) {
                    ...
                    try {
                        ...
                        Result.Companion companion2 = Result.INSTANCE;
                        objM326constructorimpl = Result.m326constructorimpl(ResultKt.createFailure(th2));
                    }
                    if (objNewInstance != null) {
                        Throwable th3 = (Throwable) objNewInstance;
                        th3.initCause(th);
                        objM326constructorimpl = Result.m326constructorimpl(th3);
                        return (Throwable) (Result.m332isFailureimpl(objM326constructorimpl) ? null : objM326constructorimpl);
                    }
            ...
            if (length == 2 && Intrinsics.areEqual(parameterTypes[0], String.class) && Intrinsics.areEqual(parameterTypes[1], Throwable.class)) {
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$1
                    ...
                    public final Throwable invoke(Throwable th) {
                        ...
                        if (objNewInstance != null) {
                            objM326constructorimpl = Result.m326constructorimpl((Throwable) objNewInstance);
                            if (Result.m332isFailureimpl(objM326constructorimpl)) {
                                objM326constructorimpl = null;
                            }
                            return (Throwable) objM326constructorimpl;
                        }
                        throw new NullPointerException("null cannot be cast to non-null type kotlin.Throwable");
                    }
                };
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    Result.Companion companion = Result.INSTANCE;
                    objM326constructorimpl = Result.m326constructorimpl(function12.invoke(th));
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM326constructorimpl = Result.m326constructorimpl(ResultKt.createFailure(th2));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM326constructorimpl = Result.m326constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM326constructorimpl = Result.m326constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m332isFailureimpl(objM326constructorimpl)) {
            objM326constructorimpl = numValueOf;
        }
        return ((Number) objM326constructorimpl).intValue();
    }

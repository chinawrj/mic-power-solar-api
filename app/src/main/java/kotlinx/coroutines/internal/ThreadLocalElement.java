...
public final class ThreadLocalElement<T> implements ThreadContextElement<T> {
    ...
    public String toString() {
        return "ThreadLocal(value=" + this.value + ", threadLocal = " + this.threadLocal + Operators.BRACKET_END;
    }
}

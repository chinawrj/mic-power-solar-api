...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM326constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM326constructorimpl = Result.m326constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m329exceptionOrNullimpl(objM326constructorimpl) == null) {
            obj2 = objM326constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM326constructorimpl2 = Result.m326constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM326constructorimpl2 = Result.m326constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m329exceptionOrNullimpl(objM326constructorimpl2) == null) {
            obj = objM326constructorimpl2;
        }

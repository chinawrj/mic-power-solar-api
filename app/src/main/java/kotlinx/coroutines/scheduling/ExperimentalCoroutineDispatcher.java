...
public class ExperimentalCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public void mo1923dispatch(CoroutineContext context, Runnable block) {
        try {
            ...
            DefaultExecutor.INSTANCE.mo1923dispatch(context, block);
        }
    }

...
final class SemaphoreSegment extends Segment<SemaphoreSegment> {
    ...
    public String toString() {
        return "SemaphoreSegment[id=" + getId() + ", hashCode=" + hashCode() + Operators.ARRAY_END;
    }
}

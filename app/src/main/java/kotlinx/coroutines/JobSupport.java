...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
    ...
    */
    ...
    private static final class Finishing implements Incomplete {
        ...
        public String toString() {
            return "Finishing[cancelling=" + isCancelling() + ", completing=" + isCompleting() + ", rootCause=" + getRootCause() + ", exceptions=" + get_exceptionsHolder() + ", list=" + getList() + Operators.ARRAY_END;
        }
    }

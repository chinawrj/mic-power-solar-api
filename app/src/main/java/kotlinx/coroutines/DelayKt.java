...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1924scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1861delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1862toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1862toDelayMillisLRDsOJo(long j) {
        if (Duration.m1697compareToLRDsOJo(j, Duration.INSTANCE.m1800getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1716getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}

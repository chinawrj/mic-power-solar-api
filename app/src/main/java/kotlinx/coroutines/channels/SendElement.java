...
public class SendElement<E> extends Send {
    ...
    public void resumeSendClosed(Closed<?> closed) {
        ...
        cancellableContinuation.resumeWith(Result.m326constructorimpl(ResultKt.createFailure(closed.getSendException())));
    }

    @Override // kotlinx.coroutines.internal.LockFreeLinkedListNode
    public String toString() {
        return DebugStringsKt.getClassSimpleName(this) + TemplateDom.SEPARATOR + DebugStringsKt.getHexAddress(this) + Operators.BRACKET_START + getPollResult() + Operators.BRACKET_END;
    }
}

...
public class ArrayChannel<E> extends AbstractChannel<E> {
    ...
    protected String getBufferDebugString() {
        return "(buffer:capacity=" + this.capacity + ",size=" + this.size + Operators.BRACKET_END;
    }
}

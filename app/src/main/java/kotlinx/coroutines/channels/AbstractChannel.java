...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final java.lang.Object mo1875receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r5) {
        /*
            r4 = this;
        ...
        L32:
            ...
            java.lang.Object r5 = r0.m1895closedJP2dKIU(r5)
            goto L52
        L4c:
            kotlinx.coroutines.channels.ChannelResult$Companion r0 = kotlinx.coroutines.channels.ChannelResult.INSTANCE
            java.lang.Object r5 = r0.m1897successJP2dKIU(r5)
        L52:
            return r5
        L53:
            r0.label = r3
        ...
        L5c:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.mo1875receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public final Object mo1876tryReceivePtdJZtk() {
        Object objPollInternal = pollInternal();
        return objPollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.INSTANCE.m1896failurePtdJZtk() : objPollInternal instanceof Closed ? ChannelResult.INSTANCE.m1895closedJP2dKIU(((Closed) objPollInternal).closeCause) : ChannelResult.INSTANCE.m1897successJP2dKIU(objPollInternal);
    }
    ...
    protected void onCancelIdempotent(boolean wasClosed) {
        ...
        while (true) {
            ...
            if (!(prevNode instanceof LockFreeLinkedListHead)) {
                ...
                if (!prevNode.mo1922remove()) {
                    prevNode.helpRemove();
                } else {
                    objM1914constructorimpl$default = InlineList.m1919plusFjFbRPM(objM1914constructorimpl$default, (Send) prevNode);
                }
            } else {
                mo1874onCancelIdempotentListww6eGU(objM1914constructorimpl$default, closedForSend);
                return;
            }
        }
    }
            ...
            while (true) {
                ...
                if (objPollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m326constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.INSTANCE;
                        cancellableContinuationImpl.resumeWith(Result.m326constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                    }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m326constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
            } else {
                ...
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m326constructorimpl(channelResultM1882boximpl));
            }
        }

        @Override // kotlinx.coroutines.internal.LockFreeLinkedListNode
        public String toString() {
            return "ReceiveElement@" + DebugStringsKt.getHexAddress(this) + "[receiveMode=" + this.receiveMode + Operators.ARRAY_END;
        }
    }
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        @Override // kotlinx.coroutines.internal.LockFreeLinkedListNode
        public String toString() {
            return "ReceiveSelect@" + DebugStringsKt.getHexAddress(this) + Operators.ARRAY_START + this.select + ",receiveMode=" + this.receiveMode + Operators.ARRAY_END;
        }
    }

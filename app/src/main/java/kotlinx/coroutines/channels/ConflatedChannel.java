...
public class ConflatedChannel<E> extends AbstractChannel<E> {
    ...
    protected String getBufferDebugString() {
        ...
        reentrantLock.lock();
        try {
            return "(value=" + this.value + Operators.BRACKET_END;
        } finally {
            reentrantLock.unlock();
        }
    }

...
final /* synthetic */ class FlowKt__MergeKt {
    ...
    static final class C02321<R, T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C02321(Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super C02321> continuation) {
            super(3, continuation);
            this.$transform = function2;
        }
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, T t, Continuation<? super Unit> continuation) {
            C02321 c02321 = new C02321(this.$transform, continuation);
            c02321.L$0 = flowCollector;
            c02321.L$1 = t;
    ...
    public static final <T, R> Flow<R> mapLatest(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2) {
        return FlowKt.transformLatest(flow, new C02321(function2, null));
    }

...
public final class FlowKt__ReduceKt$first$$inlined$collectWhile$2<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2", f = "Reduce.kt", i = {0, 0}, l = {EUCJPContextAnalysis.SINGLE_SHIFT_2}, m = "emit", n = {"this", "it"}, s = {"L$0", "L$1"})

...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
    ...
    public final void handleBuilderException(Throwable e) {
        if (trySelect()) {
            ...
            resumeWith(Result.m326constructorimpl(ResultKt.createFailure(e)));
        } else {
    ...
    private static final class AtomicSelectOp extends AtomicOp<Object> {
        ...
        @Override // kotlinx.coroutines.internal.OpDescriptor
        public String toString() {
            return "AtomicSelectOp(sequence=" + getOpSequence() + Operators.BRACKET_END;
        }
    }
    ...
    public void resumeWith(Object result) {
        ...
        while (true) {
            ...
            if (obj == SelectKt.UNDECIDED) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.RESUMED)) {
                    if (Result.m332isFailureimpl(result)) {
                        Continuation<R> continuation = this.uCont;
                        Throwable thM329exceptionOrNullimpl = Result.m329exceptionOrNullimpl(result);
                        Intrinsics.checkNotNull(thM329exceptionOrNullimpl);
                        Result.Companion companion = Result.INSTANCE;
                        if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                            thM329exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(thM329exceptionOrNullimpl, (CoroutineStackFrame) continuation);
                        }
                        continuation.resumeWith(Result.m326constructorimpl(ResultKt.createFailure(thM329exceptionOrNullimpl)));
                        return;
                    }
        ...
        while (true) {
            ...
            if (obj == SelectKt.UNDECIDED) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.RESUMED)) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    continuationIntercepted.resumeWith(Result.m326constructorimpl(ResultKt.createFailure(exception)));
                    return;
                }
            } else {
                throw new IllegalStateException("Already resumed");

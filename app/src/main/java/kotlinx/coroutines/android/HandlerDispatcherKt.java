...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM326constructorimpl = Result.m326constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM326constructorimpl = Result.m326constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m332isFailureimpl(objM326constructorimpl) ? null : objM326constructorimpl);
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1923dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1

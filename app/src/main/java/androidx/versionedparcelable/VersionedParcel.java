...
public abstract class VersionedParcel {
    ...
    private void writeSerializable(Serializable serializable) throws IOException {
        ...
        try {
            ...
            throw new RuntimeException("VersionedParcelable encountered IOException writing serializable object (name = " + name + Operators.BRACKET_END_STR, e);
        }
    }
    ...
    protected Serializable readSerializable() {
        ...
        try {
            ...
            throw new RuntimeException("VersionedParcelable encountered IOException reading a Serializable object (name = " + string + Operators.BRACKET_END_STR, e);
        } catch (ClassNotFoundException e2) {
            throw new RuntimeException("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = " + string + Operators.BRACKET_END_STR, e2);
        }
    }

...
class ProfileTranscoder {
    ...
    private static String generateDexKey(String str, String str2, byte[] bArr) {
        ...
        if (str2.contains(Operators.AND_NOT) || str2.contains(":")) {
            return enforceSeparator(str2, strDexKeySeparator);
        }
    ...
    private static String enforceSeparator(String str, String str2) {
        if (Operators.AND_NOT.equals(str2)) {
            return str.replace(":", Operators.AND_NOT);
        }
        return ":".equals(str2) ? str.replace(Operators.AND_NOT, ":") : str;
    }

    private static String extractKey(String str) {
        int iIndexOf = str.indexOf(Operators.AND_NOT);
        if (iIndexOf < 0) {

        ...
        try {
            ...
            while (entry != null) {
                ...
                while (i2 < 3 && !z) {
                    ...
                    sb.append(z ? "succeeded" : AbsoluteConst.EVENTS_FAILED);
                    sb.append(" '");
    ...
    private static void extract(ZipFile zipFile, ZipEntry zipEntry, File file, String str) throws IOException {
        ...
        try {
            ...
            try {
                ...
                throw new IOException("Failed to rename \"" + fileCreateTempFile.getAbsolutePath() + "\" to \"" + file.getAbsolutePath() + JSUtil.QUOTE);
            } catch (Throwable th) {
                zipOutputStream.close();
                throw th;
            }

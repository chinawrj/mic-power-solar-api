    ...
    static CentralDirectory findCentralDirectory(RandomAccessFile randomAccessFile) throws IOException {
        ...
        do {
            ...
            if (randomAccessFile.readInt() == iReverseBytes) {
                ...
                centralDirectory.size = Integer.reverseBytes(randomAccessFile.readInt()) & InternalZipConstants.ZIP_64_SIZE_LIMIT;
                centralDirectory.offset = Integer.reverseBytes(randomAccessFile.readInt()) & InternalZipConstants.ZIP_64_SIZE_LIMIT;

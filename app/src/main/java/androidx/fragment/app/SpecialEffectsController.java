...
abstract class SpecialEffectsController {
    ...
    static class Operation {
        ...
        public String toString() {
            return "Operation {" + Integer.toHexString(System.identityHashCode(this)) + "} {mFinalState = " + this.mFinalState + "} {mLifecycleImpact = " + this.mLifecycleImpact + "} {mFragment = " + this.mFragment + Operators.BLOCK_END_STR;
        }

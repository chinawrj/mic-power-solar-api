...
public class ConstraintWidget {
    ...
    public String toString() {
        ...
        String str2 = "";
        if (this.mType != null) {
            str = "type: " + this.mType + Operators.SPACE_STR;
        } else {
            str = "";
        }
        sb.append(str);
        if (this.mDebugName != null) {
            str2 = "id: " + this.mDebugName + Operators.SPACE_STR;
        }
        sb.append(str2);
  ...
  0x0086: PHI (r0v2 int) = (r0v1 int), (r0v0 int), (r0v0 int), (r0v0 int), (r0v0 int), (r0v0 int) binds: [B:46:0x0086, B:36:0x007f, B:24:0x0051, B:26:0x0057, B:28:0x0063, B:30:0x0067] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:125:0x024f A[RETURN] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:175:0x02fa A[ADDED_TO_REGION] */

...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo179clone = transition.mo179clone();
        transitionMo179clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo179clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo179clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo179clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo179clone = transition.mo179clone();
        sceneChangeSetup(viewGroup, transitionMo179clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo179clone);
    }

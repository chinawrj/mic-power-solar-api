...
public final class LinkifyCompat {
    ...
    public static boolean addLinks(Spannable spannable, int i) throws UnsupportedEncodingException {
        ...
        if ((i & 1) != 0) {
            gatherLinks(arrayList, spannable, PatternsCompat.AUTOLINK_WEB_URL, new String[]{DeviceInfo.HTTP_PROTOCOL, DeviceInfo.HTTPS_PROTOCOL, "rtsp://"}, Linkify.sUrlMatchFilter, null);
        }
        if ((i & 2) != 0) {

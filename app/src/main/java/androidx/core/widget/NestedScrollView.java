...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        int i = SJISContextAnalysis.HIRAGANA_HIGHBYTE;
        if (!zCanScroll) {
            ...
            View viewFindNextFocus = FocusFinder.getInstance().findNextFocus(this, viewFindFocus, SJISContextAnalysis.HIRAGANA_HIGHBYTE);
            return (viewFindNextFocus == null || viewFindNextFocus == this || !viewFindNextFocus.requestFocus(SJISContextAnalysis.HIRAGANA_HIGHBYTE)) ? false : true;
        }
        ...
        if (keyCode == 20) {
            if (keyEvent.isAltPressed()) {
                return fullScroll(SJISContextAnalysis.HIRAGANA_HIGHBYTE);
            }
            return arrowScroll(SJISContextAnalysis.HIRAGANA_HIGHBYTE);
        }
        if (keyCode == 62) {
        ...
        pageScroll(SJISContextAnalysis.HIRAGANA_HIGHBYTE);
        return false;
    }
    ...
    */
    ...
    protected boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        if (i == 2) {
            i = SJISContextAnalysis.HIRAGANA_HIGHBYTE;
        } else if (i == 1) {
            i = 33;
        }
        if (rect == null) {
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            return "HorizontalScrollView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " scrollPosition=" + this.scrollPosition + Operators.BLOCK_END_STR;
        }
    }

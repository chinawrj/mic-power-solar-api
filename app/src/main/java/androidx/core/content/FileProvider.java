    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) throws IOException {
            ...
            try {
                ...
                return new Uri.Builder().scheme(UriUtil.LOCAL_CONTENT_SCHEME).authority(this.mAuthority).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(strSubstring, "/")).build();

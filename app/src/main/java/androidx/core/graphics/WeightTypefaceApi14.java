...
final class WeightTypefaceApi14 {
    ...
    private static Typeface getBestFontFromFamily(TypefaceCompatBaseImpl typefaceCompatBaseImpl, Context context, Typeface typeface, int i, boolean z) throws NoSuchFieldException {

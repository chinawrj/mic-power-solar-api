...
public final class UriCompat {
    ...
    public static String toSafeString(Uri uri) {
        ...
        if (scheme != null) {
            if (scheme.equalsIgnoreCase(Constants.Value.TEL) || scheme.equalsIgnoreCase("sip") || scheme.equalsIgnoreCase("sms") || scheme.equalsIgnoreCase("smsto") || scheme.equalsIgnoreCase("mailto") || scheme.equalsIgnoreCase("nfc")) {

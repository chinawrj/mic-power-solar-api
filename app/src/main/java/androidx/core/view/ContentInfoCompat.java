...
public final class ContentInfoCompat {
    ...
    public ContentInfo toContentInfo() {
        return HalfKt$$ExternalSyntheticApiModelOutline0.m93m(Objects.requireNonNull(this.mCompat.getWrapped()));
    }
    ...
    private static final class CompatImpl implements Compat {
        ...
        public String toString() {
            ...
            if (this.mLinkUri == null) {
                ...
                str = ", hasLinkUri(" + this.mLinkUri.toString().length() + Operators.BRACKET_END_STR;
            }
            sb.append(str);
    ...
    private static final class Compat31Impl implements Compat {
        ...
        Compat31Impl(ContentInfo contentInfo) {
            this.mWrapped = HalfKt$$ExternalSyntheticApiModelOutline0.m93m(Preconditions.checkNotNull(contentInfo));
        }
        ...
        public String toString() {
            return "ContentInfoCompat{" + this.mWrapped + Operators.BLOCK_END_STR;
        }
    }
    ...
    private static final class BuilderCompat31Impl implements BuilderCompat {
        ...
        BuilderCompat31Impl(ContentInfoCompat contentInfoCompat) {
            HalfKt$$ExternalSyntheticApiModelOutline0.m98m();
            this.mPlatformBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m92m(contentInfoCompat.toContentInfo());
        }

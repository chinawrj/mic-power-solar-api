...
public final class WindowInsetsAnimationCompat {
    ...
    public static final class BoundsCompat {
        ...
        public String toString() {
            return "Bounds{lower=" + this.mLowerBound + " upper=" + this.mUpperBound + Operators.BLOCK_END_STR;
        }
    ...
    private static class Impl30 extends Impl {
        ...
        private static class ProxyCallback extends WindowInsetsAnimation$Callback {
            ...
            public WindowInsets onProgress(WindowInsets windowInsets, List<WindowInsetsAnimation> list) {
                ...
                for (int size = list.size() - 1; size >= 0; size--) {
                    WindowInsetsAnimation windowInsetsAnimationM118m = ViewCompat$$ExternalSyntheticApiModelOutline0.m118m((Object) list.get(size));
                    WindowInsetsAnimationCompat windowInsetsAnimationCompat = getWindowInsetsAnimationCompat(windowInsetsAnimationM118m);
                    windowInsetsAnimationCompat.setFraction(windowInsetsAnimationM118m.getFraction());
        ...
        public static WindowInsetsAnimation.Bounds createPlatformBounds(BoundsCompat boundsCompat) {
            ViewCompat$$ExternalSyntheticApiModelOutline0.m125m();

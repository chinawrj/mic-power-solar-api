...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = ViewCompat$$ExternalSyntheticApiModelOutline0.m114m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            WindowInsets.Builder builderM114m;
            super(windowInsetsCompat);
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                builderM114m = ViewCompat$$ExternalSyntheticApiModelOutline0.m115m(windowInsets);
            } else {
                builderM114m = ViewCompat$$ExternalSyntheticApiModelOutline0.m114m();
            }
            this.mPlatBuilder = builderM114m;
        }

...
public abstract class AbstractResolvableFuture<V> implements ListenableFuture<V> {
    ...
    static final boolean GENERATE_CANCELLATION_CAUSES = Boolean.parseBoolean(System.getProperty("guava.concurrent.generate_cancellation_cause", AbsoluteConst.FALSE));
    ...
    public final V get(long j, TimeUnit timeUnit) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        if (nanos + 1000 < 0) {
            ...
            if (jConvert > 0) {
                String str3 = str2 + jConvert + Operators.SPACE_STR + lowerCase;
                if (z) {
                    str3 = str3 + ",";
                }
    ...
    protected String pendingToString() {
        Object obj = this.value;
        if (obj instanceof SetFuture) {
            return "setFuture=[" + userObjectToString(((SetFuture) obj).future) + Operators.ARRAY_END_STR;
        }

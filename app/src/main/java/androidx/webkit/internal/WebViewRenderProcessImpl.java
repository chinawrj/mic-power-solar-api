...
public class WebViewRenderProcessImpl extends WebViewRenderProcess {
    ...
    public boolean terminate() {
        ...
        if (q.isSupportedByFramework()) {
            android.webkit.WebViewRenderProcess webViewRenderProcessM163m = Trace$$ExternalSyntheticApiModelOutline0.m163m((Object) this.mFrameworkObject.get());
            return webViewRenderProcessM163m != null && ApiHelperForQ.terminate(webViewRenderProcessM163m);
        }

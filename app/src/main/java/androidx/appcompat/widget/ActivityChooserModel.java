...
class ActivityChooserModel extends DataSetObservable {
    ...
    public static final class HistoricalRecord {
        ...
        public String toString() {
            return "[; activity:" + this.activity + "; time:" + this.time + "; weight:" + new BigDecimal(this.weight) + Operators.ARRAY_END_STR;
        }
    }
    ...
    public static final class ActivityResolveInfo implements Comparable<ActivityResolveInfo> {
        ...
        public String toString() {
            return "[resolveInfo:" + this.resolveInfo.toString() + "; weight:" + new BigDecimal(this.weight) + Operators.ARRAY_END_STR;
        }
    }

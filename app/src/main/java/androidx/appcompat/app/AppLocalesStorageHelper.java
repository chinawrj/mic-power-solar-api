...
class AppLocalesStorageHelper {
    ...
    */
    static java.lang.String readLocales(android.content.Context r9) throws java.io.IOException {
        /*
    ...
    static class SerialExecutor implements Executor {
            ...
            synchronized (this.mLock) {
                this.mTasks.add(new Runnable() { // from class: androidx.appcompat.app.AppLocalesStorageHelper$SerialExecutor$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m44xd188c474(runnable);
                    }
                });
        ...
        /* synthetic */ void m44xd188c474(Runnable runnable) {
            try {
                runnable.run();
            } finally {
                scheduleNext();

        ...
        while (i2 < length) {
            ...
            if (cCharAt2 < 128) {
                ...
                try {
                    ...
                    byteBuffer.put(i3, (byte) ((cCharAt2 & Operators.CONDITION_IF) | 128));
                    iPosition = i3;
                ...
                byteBuffer.put(iPosition, (byte) ((cCharAt2 & Operators.CONDITION_IF) | 128));
            } else {
                int i5 = i2 + 1;
                if (i5 != length) {
                    try {
                        ...
                        if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                            ...
                            int i6 = iPosition + 1;
                            try {
                                byteBuffer.put(iPosition, (byte) ((codePoint >>> 18) | HebrewProber.NORMAL_NUN));
                                i = iPosition + 2;
    ...
    private static int encodeUtf8Array(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i6 < length) {
            ...
            if (cCharAt2 < 128 && i7 < i5) {
                ...
                i7 += 2;
                bArr[i8] = (byte) ((cCharAt2 & Operators.CONDITION_IF) | 128);
            } else {
                if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || i7 > i5 - 3) {
                    if (i7 <= i5 - 4) {
                        ...
                        if (i9 != charSequence.length()) {
                            ...
                            if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                bArr[i7] = (byte) ((codePoint >>> 18) | HebrewProber.NORMAL_NUN);
                ...
                i7 += 3;
                bArr[i11] = (byte) ((cCharAt2 & Operators.CONDITION_IF) | 128);
            }
            i6++;
        }
        return i7;

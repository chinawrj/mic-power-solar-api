    ...
    public final R runCallLoop() {
        while (true) {
            ...
            if (continuation != null) {
                if (!Result.m328equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, r)) {
                    this.result = DeepRecursiveKt.UNDEFINED_RESULT;
                    ...
                    try {
                        ...
                        if (objInvoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                            ...
                            continuation.resumeWith(Result.m326constructorimpl(objInvoke));
                        }
                    } catch (Throwable th) {

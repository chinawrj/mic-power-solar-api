...
public final class TypeReference implements KType {
    ...
    private final String asString(boolean convertPrimitiveToWrapper) {
        ...
        String str = name + (getArguments().isEmpty() ? "" : CollectionsKt.joinToString$default(getArguments(), ", ", Operators.L, Operators.G, 0, null, new Function1<KTypeProjection, CharSequence>() { // from class: kotlin.jvm.internal.TypeReference$asString$args$1
            {
                super(1);
            }
        ...
        }, 24, null)) + (isMarkedNullable() ? Operators.CONDITION_IF_STRING : "");
        ...
        if (Intrinsics.areEqual(strAsString, str + Operators.CONDITION_IF)) {
            return str + '!';
        }
        return Operators.BRACKET_START_STR + str + PdrUtil.FILE_PATH_ENTRY_BACK + strAsString + Operators.BRACKET_END;
    }

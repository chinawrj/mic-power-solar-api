...
public final class ReflectJvmMapping {
    ...
    public static final Method getJavaMethod(KFunction<?> kFunction) {
        ...
        Member memberMo1610getMember = (kCallableImplAsKCallableImpl == null || (caller = kCallableImplAsKCallableImpl.getCaller()) == null) ? null : caller.mo1610getMember();
        if (memberMo1610getMember instanceof Method) {
            return (Method) memberMo1610getMember;
        }
        return null;
    }
    ...
    public static final <T> Constructor<T> getJavaConstructor(KFunction<? extends T> kFunction) {
        ...
        KCallableImpl<?> kCallableImplAsKCallableImpl = UtilKt.asKCallableImpl(kFunction);
        Member memberMo1610getMember = (kCallableImplAsKCallableImpl == null || (caller = kCallableImplAsKCallableImpl.getCaller()) == null) ? null : caller.mo1610getMember();
        if (memberMo1610getMember instanceof Constructor) {
            return (Constructor) memberMo1610getMember;
        }
        return null;
    }

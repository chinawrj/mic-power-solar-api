...
public final class KCallablesJvm {
    public static final boolean isAccessible(KCallable<?> kCallable) {
        ...
        if (kCallable instanceof KMutableProperty) {
            ...
            Object objMo1610getMember = (kCallableImplAsKCallableImpl == null || (defaultCaller = kCallableImplAsKCallableImpl.getDefaultCaller()) == null) ? null : defaultCaller.mo1610getMember();
            AccessibleObject accessibleObject = objMo1610getMember instanceof AccessibleObject ? (AccessibleObject) objMo1610getMember : null;

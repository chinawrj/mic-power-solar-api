    ...
    public static final KClass<?> getJvmErasure(KClassifier kClassifier) {
        ...
        if (kClassifier instanceof KTypeParameter) {
            ...
            while (true) {
                ...
                ClassifierDescriptor classifierDescriptorMo1618getDeclarationDescriptor = ((KTypeImpl) kType).getType().getConstructor().mo1618getDeclarationDescriptor();
                classDescriptor = classifierDescriptorMo1618getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo1618getDeclarationDescriptor : null;

...
public final class UtilKt {
    ...
    private static final Class<?> loadClass(ClassLoader classLoader, String str, String str2, int i) {
        ...
        String str3 = str + Operators.DOT + StringsKt.replace$default(str2, Operators.DOT, '$', false, 4, (Object) null);
        if (i > 0) {
            str3 = StringsKt.repeat(Operators.ARRAY_START_STR, i) + 'L' + str3 + ';';
        }
    ...
    private static final Object toRuntimeValue(ConstantValue<?> constantValue, ClassLoader classLoader) {
        ...
        if (constantValue instanceof EnumValue) {
            ...
            ClassifierDescriptor classifierDescriptorMo1618getDeclarationDescriptor = ((KClassValue.Value.LocalClass) value2).getType().getConstructor().mo1618getDeclarationDescriptor();

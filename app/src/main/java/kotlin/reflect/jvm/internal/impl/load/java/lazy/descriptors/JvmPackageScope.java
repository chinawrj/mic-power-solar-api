...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo1620getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassDescriptor classDescriptorMo1620getContributedClassifier = this.javaScope.mo1620getContributedClassifier(name, location);
        if (classDescriptorMo1620getContributedClassifier != null) {
            return classDescriptorMo1620getContributedClassifier;
        }
        ClassifierDescriptor classifierDescriptor = null;
        for (MemberScope memberScope : getKotlinScopes()) {
            ClassifierDescriptor contributedClassifier = memberScope.mo1620getContributedClassifier(name, location);

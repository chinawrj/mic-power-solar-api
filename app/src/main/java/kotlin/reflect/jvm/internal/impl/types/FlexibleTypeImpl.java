...
public final class FlexibleTypeImpl extends FlexibleType implements CustomTypeParameter {
    ...
    public boolean isTypeParameter() {
        return (getLowerBound().getConstructor().mo1618getDeclarationDescriptor() instanceof TypeParameterDescriptor) && Intrinsics.areEqual(getLowerBound().getConstructor(), getUpperBound().getConstructor());
    }
    ...
    public String render(DescriptorRenderer renderer, DescriptorRendererOptions options) {
        ...
        if (options.getDebugMode()) {
            return Operators.BRACKET_START_STR + renderer.renderType(getLowerBound()) + PdrUtil.FILE_PATH_ENTRY_BACK + renderer.renderType(getUpperBound()) + Operators.BRACKET_END;
        }
    ...
    public String toString() {
        return Operators.BRACKET_START_STR + getLowerBound() + PdrUtil.FILE_PATH_ENTRY_BACK + getUpperBound() + Operators.BRACKET_END;
    }

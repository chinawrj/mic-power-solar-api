...
public final class InlineClassAwareCallerKt {
    ...
    public static final Method getUnboxMethod(Class<?> cls, CallableMemberDescriptor descriptor) throws NoSuchMethodException, SecurityException {
    ...
    public static final Method getBoxMethod(Class<?> cls, CallableMemberDescriptor descriptor) throws NoSuchMethodException, SecurityException {
        Intrinsics.checkNotNullParameter(cls, "<this>");
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        try {
            ...
            throw new KotlinReflectionInternalError("No box method found in inline class: " + cls + " (calling " + descriptor + Operators.BRACKET_END);
        }
    }

    public static final Class<?> toInlineClass(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        Class<?> inlineClass = toInlineClass(kotlinType.getConstructor().mo1618getDeclarationDescriptor());
        if (inlineClass == null) {
            return null;
        }

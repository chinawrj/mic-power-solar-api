...
public final class ReflectionObjectRenderer {
    ...
    public final String renderFunction(FunctionDescriptor descriptor) {
        ...
        CollectionsKt.joinTo$default(valueParameters, sb, ", ", Operators.BRACKET_START_STR, Operators.BRACKET_END_STR, 0, null, new Function1<ValueParameterDescriptor, CharSequence>() { // from class: kotlin.reflect.jvm.internal.ReflectionObjectRenderer$renderFunction$1$1
    ...
    public final String renderLambda(FunctionDescriptor invoke) {
        ...
        CollectionsKt.joinTo$default(valueParameters, sb, ", ", Operators.BRACKET_START_STR, Operators.BRACKET_END_STR, 0, null, new Function1<ValueParameterDescriptor, CharSequence>() { // from class: kotlin.reflect.jvm.internal.ReflectionObjectRenderer$renderLambda$1$1
            @Override // kotlin.jvm.functions.Function1
            public final CharSequence invoke(ValueParameterDescriptor valueParameterDescriptor) {
                ReflectionObjectRenderer reflectionObjectRenderer2 = ReflectionObjectRenderer.INSTANCE;
                KotlinType type = valueParameterDescriptor.getType();

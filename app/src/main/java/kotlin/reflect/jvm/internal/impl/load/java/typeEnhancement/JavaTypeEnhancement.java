...
public final class JavaTypeEnhancement {
    ...
    */
    ...
    private final SimpleResult enhanceInflexible(SimpleType simpleType, Function1<? super Integer, JavaTypeQualifiers> function1, int i, TypeComponentPosition typeComponentPosition, boolean z, boolean z2) {
        ...
        ClassifierDescriptor classifierDescriptorMo1618getDeclarationDescriptor = simpleType.getConstructor().mo1618getDeclarationDescriptor();
        ...
        ClassifierDescriptor classifierDescriptorEnhanceMutability = TypeEnhancementKt.enhanceMutability(classifierDescriptorMo1618getDeclarationDescriptor, javaTypeQualifiersInvoke, typeComponentPosition);

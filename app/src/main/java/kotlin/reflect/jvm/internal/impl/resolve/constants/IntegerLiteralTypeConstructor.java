...
public final class IntegerLiteralTypeConstructor implements TypeConstructor {
    ...
    private final String valueToString() {
        return Operators.ARRAY_START_STR + CollectionsKt.joinToString$default(this.possibleTypes, ",", null, null, 0, null, new Function1<KotlinType, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.constants.IntegerLiteralTypeConstructor.valueToString.1

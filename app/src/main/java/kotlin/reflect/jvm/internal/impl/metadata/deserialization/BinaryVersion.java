...
public abstract class BinaryVersion {
    ...
    public BinaryVersion(int... numbers) {
        ...
        if (numbers.length > 3) {
            if (numbers.length > 1024) {
                throw new IllegalArgumentException("BinaryVersion with length more than 1024 are not supported. Provided length " + numbers.length + Operators.DOT);
            }
    ...
    public String toString() {
        ...
        return arrayList2.isEmpty() ? "unknown" : CollectionsKt.joinToString$default(arrayList2, Operators.DOT_STR, null, null, 0, null, null, 62, null);
    }

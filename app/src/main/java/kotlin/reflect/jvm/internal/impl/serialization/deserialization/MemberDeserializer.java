...
public final class MemberDeserializer {
    ...
    public final PropertyDescriptor loadProperty(final ProtoBuf.Property proto) {
        ...
        while (it.hasNext()) {
            arrayList.add(toContextReceiver((ProtoBuf.Type) it.next(), deserializationContextChildContext$default, deserializedPropertyDescriptor));
        }
        ...
        deserializedPropertyDescriptor.initialize(propertyGetterDescriptorImpl2, propertySetterDescriptorImplCreateDefaultSetter, new FieldDescriptorImpl(getPropertyFieldAnnotations(proto, false), deserializedPropertyDescriptor2), new FieldDescriptorImpl(getPropertyFieldAnnotations(proto, z), deserializedPropertyDescriptor2));
    ...
    public final SimpleFunctionDescriptor loadFunction(ProtoBuf.Function proto) {
        ...
        Iterator<T> it = listContextReceiverTypes.iterator();
        while (it.hasNext()) {
            ReceiverParameterDescriptor contextReceiver = toContextReceiver((ProtoBuf.Type) it.next(), deserializationContextChildContext$default, deserializedSimpleFunctionDescriptor);
    ...
    */
    ...
    private final ReceiverParameterDescriptor toContextReceiver(ProtoBuf.Type type, DeserializationContext deserializationContext, CallableDescriptor callableDescriptor) {
        return DescriptorFactory.createContextReceiverParameterForCallable(callableDescriptor, deserializationContext.getTypeDeserializer().type(type), null, Annotations.Companion.getEMPTY());
    }
}

...
public final class DescriptorUtilsKt {
    ...
    public static final ClassDescriptor resolveTopLevelClass(ModuleDescriptor moduleDescriptor, FqName topLevelClassFqName, LookupLocation location) {
        ...
        ClassifierDescriptor contributedClassifier = memberScope.mo1620getContributedClassifier(nameShortName, location);
    ...
    public static final ClassDescriptor getSuperClassNotAny(ClassDescriptor classDescriptor) {
        ...
        for (KotlinType kotlinType : classDescriptor.getDefaultType().getConstructor().mo1619getSupertypes()) {
            if (!KotlinBuiltIns.isAnyOrNullableAny(kotlinType)) {
                ...
                if (DescriptorUtils.isClassOrEnumClass(classifierDescriptorMo1618getDeclarationDescriptor)) {
    ...
    public static final ClassDescriptor getAnnotationClass(AnnotationDescriptor annotationDescriptor) {
        ...
        ClassifierDescriptor classifierDescriptorMo1618getDeclarationDescriptor = annotationDescriptor.getType().getConstructor().mo1618getDeclarationDescriptor();

...
public final class SignatureBuildingComponents {
    ...
    public final Set<String> inClass(String internalName, String... signatures) {
        ...
        for (String str : signatures) {
            linkedHashSet.add(internalName + Operators.DOT + str);
        }
    ...
    public final String signature(String internalName, String jvmDescriptor) {
        ...
        return internalName + Operators.DOT + jvmDescriptor;
    }
    ...
    public final String jvmDescriptor(String name, List<String> parameters, String ret) {
        ...
        return name + Operators.BRACKET_START + CollectionsKt.joinToString$default(parameters, "", null, null, 0, null, new Function1<String, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.load.kotlin.SignatureBuildingComponents.jvmDescriptor.1
            @Override // kotlin.jvm.functions.Function1
            public final CharSequence invoke(String it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return SignatureBuildingComponents.INSTANCE.escapeClassName(it);
            }
        }, 30, null) + Operators.BRACKET_END + escapeClassName(ret);
    }

...
public final class ClassId {
    ...
    */
    ...
    public FqName asSingleFqName() {
        ...
        return new FqName(this.packageFqName.asString() + Operators.DOT_STR + this.relativeClassName.asString());
    }
    ...
    public static ClassId fromString(String str, boolean z) {
        ...
        if (iLastIndexOf == -1) {
            ...
            String strReplace = str.substring(0, iLastIndexOf).replace('/', Operators.DOT);
    ...
    public String asString() {
        ...
        String str = this.packageFqName.asString().replace(Operators.DOT, '/') + "/" + this.relativeClassName.asString();
        if (str == null) {
            $$$reportNull$$$0(14);
        }
        return str;

    ...
    private static final KotlinType buildStarProjectionTypeByTypeParameters(final List<? extends TypeConstructor> list, List<? extends KotlinType> list2, KotlinBuiltIns kotlinBuiltIns) {
        SimpleType simpleTypeSubstitute = TypeSubstitutor.create(new TypeConstructorSubstitution() { // from class: kotlin.reflect.jvm.internal.impl.types.StarProjectionImplKt.buildStarProjectionTypeByTypeParameters.1
            ...
            public TypeProjection get(TypeConstructor key) {
                ...
                ClassifierDescriptor classifierDescriptorMo1618getDeclarationDescriptor = key.mo1618getDeclarationDescriptor();
                Intrinsics.checkNotNull(classifierDescriptorMo1618getDeclarationDescriptor, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.TypeParameterDescriptor");
                return TypeUtils.makeStarProjection((TypeParameterDescriptor) classifierDescriptorMo1618getDeclarationDescriptor);
            }

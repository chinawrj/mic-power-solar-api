...
public final class KFunctionImpl extends KCallableImpl<Object> implements FunctionBase<Object>, KFunction<Object>, FunctionWithAllInvokes {
    ...
    private KFunctionImpl(KDeclarationContainerImpl kDeclarationContainerImpl, final String str, String str2, FunctionDescriptor functionDescriptor, Object obj) {
        ...
        this.caller = ReflectProperties.lazy(new Function0<Caller<? extends Executable>>() { // from class: kotlin.reflect.jvm.internal.KFunctionImpl$caller$2
            {
                super(0);
            }
            ...
            public final Caller<? extends Executable> invoke() throws NoSuchMethodException, SecurityException {
                ...
                if (constructor instanceof Constructor) {
                    ...
                    if (!Modifier.isStatic(method.getModifiers())) {
                        ...
                        methodCreateJvmStaticInObjectCaller = this.this$0.getDescriptor().getAnnotations().mo1613findAnnotation(UtilKt.getJVM_STATIC()) != null ? this.this$0.createJvmStaticInObjectCaller(method) : this.this$0.createStaticMethodCaller(method);
                    }
                    methodCreateConstructorCaller = methodCreateJvmStaticInObjectCaller;
                } else {
                    throw new KotlinReflectionInternalError("Could not compute caller for function: " + this.this$0.getDescriptor() + " (member = " + constructor + Operators.BRACKET_END);
                }
        ...
        this.defaultCaller = ReflectProperties.lazy(new Function0<Caller<? extends Executable>>() { // from class: kotlin.reflect.jvm.internal.KFunctionImpl$defaultCaller$2
            {
                super(0);
            }

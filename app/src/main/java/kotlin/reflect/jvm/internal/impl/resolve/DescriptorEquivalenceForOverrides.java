...
public final class DescriptorEquivalenceForOverrides {
    ...
    public static final boolean areCallableDescriptorsEquivalent$lambda$0(boolean z, final CallableDescriptor a, final CallableDescriptor b, TypeConstructor c1, TypeConstructor c2) {
        ...
        ClassifierDescriptor classifierDescriptorMo1618getDeclarationDescriptor = c1.mo1618getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo1618getDeclarationDescriptor2 = c2.mo1618getDeclarationDescriptor();
        if ((classifierDescriptorMo1618getDeclarationDescriptor instanceof TypeParameterDescriptor) && (classifierDescriptorMo1618getDeclarationDescriptor2 instanceof TypeParameterDescriptor)) {
            return INSTANCE.areTypeParametersEquivalent((TypeParameterDescriptor) classifierDescriptorMo1618getDeclarationDescriptor, (TypeParameterDescriptor) classifierDescriptorMo1618getDeclarationDescriptor2, z, new Function2<DeclarationDescriptor, DeclarationDescriptor, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$areCallableDescriptorsEquivalent$overridingUtil$1$1

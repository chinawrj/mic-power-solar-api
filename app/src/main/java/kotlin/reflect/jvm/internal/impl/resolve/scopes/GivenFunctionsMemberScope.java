...
public abstract class GivenFunctionsMemberScope extends MemberScopeImpl {
    ...
    public final List<DeclarationDescriptor> createFakeOverrides(List<? extends FunctionDescriptor> list) {
        ...
        Collection<KotlinType> collectionMo1619getSupertypes = this.containingClass.getTypeConstructor().mo1619getSupertypes();
        Intrinsics.checkNotNullExpressionValue(collectionMo1619getSupertypes, "containingClass.typeConstructor.supertypes");

...
public interface ResolutionScope {
    ...
    ClassifierDescriptor mo1620getContributedClassifier(Name name, LookupLocation lookupLocation);
    ...
    void mo1624recordLookup(Name name, LookupLocation lookupLocation);

...
public final class SubstitutingScope implements MemberScope {
    ...
    public void mo1624recordLookup(Name name, LookupLocation lookupLocation) {
    ...
    public ClassifierDescriptor mo1620getContributedClassifier(Name name, LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        ClassifierDescriptor contributedClassifier = this.workerScope.mo1620getContributedClassifier(name, location);

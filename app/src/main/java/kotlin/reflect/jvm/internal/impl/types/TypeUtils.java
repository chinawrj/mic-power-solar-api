...
public class TypeUtils {
    ...
    */
    ...
    public static List<KotlinType> getImmediateSupertypes(KotlinType kotlinType) {
        ...
        Collection<KotlinType> collectionMo1619getSupertypes = kotlinType.getConstructor().mo1619getSupertypes();
        ArrayList arrayList = new ArrayList(collectionMo1619getSupertypes.size());
        Iterator<KotlinType> it = collectionMo1619getSupertypes.iterator();
        while (it.hasNext()) {
    ...
    public static boolean isNullableType(KotlinType kotlinType) {
        ...
        if (constructor instanceof IntersectionTypeConstructor) {
            Iterator<KotlinType> it = constructor.mo1619getSupertypes().iterator();
            while (it.hasNext()) {
    ...
    public static boolean hasNullableSuperType(KotlinType kotlinType) {
        ...
        if (kotlinType.getConstructor().mo1618getDeclarationDescriptor() instanceof ClassDescriptor) {
            return false;
        }
    ...
    public static ClassDescriptor getClassDescriptor(KotlinType kotlinType) {
        ...
        if (classifierDescriptorMo1618getDeclarationDescriptor instanceof ClassDescriptor) {
            return (ClassDescriptor) classifierDescriptorMo1618getDeclarationDescriptor;
        }
        return null;
    }
    ...
    private static boolean contains(KotlinType kotlinType, Function1<UnwrappedType, Boolean> function1, SmartSet<KotlinType> smartSet) {
        ...
        TypeConstructor constructor = kotlinType.getConstructor();
        if (constructor instanceof IntersectionTypeConstructor) {
            Iterator<KotlinType> it = ((IntersectionTypeConstructor) constructor).mo1619getSupertypes().iterator();
            while (it.hasNext()) {
    ...
    public static TypeParameterDescriptor getTypeParameterDescriptorOrNull(KotlinType kotlinType) {
        ...
        if (kotlinType.getConstructor().mo1618getDeclarationDescriptor() instanceof TypeParameterDescriptor) {
            return (TypeParameterDescriptor) kotlinType.getConstructor().mo1618getDeclarationDescriptor();
        }
        return null;
    }
}

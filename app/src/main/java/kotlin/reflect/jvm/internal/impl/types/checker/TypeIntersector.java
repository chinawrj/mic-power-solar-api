    ...
    public final SimpleType intersectTypes$descriptors(List<? extends SimpleType> types) {
        ...
        for (SimpleType simpleType : types) {
            if (simpleType.getConstructor() instanceof IntersectionTypeConstructor) {
                Collection<KotlinType> collectionMo1619getSupertypes = simpleType.getConstructor().mo1619getSupertypes();
                Intrinsics.checkNotNullExpressionValue(collectionMo1619getSupertypes, "type.constructor.supertypes");
                Collection<KotlinType> collection = collectionMo1619getSupertypes;

...
public abstract class DeclarationDescriptorImpl extends AnnotatedImpl implements DeclarationDescriptor {
    ...
    public static String toString(DeclarationDescriptor declarationDescriptor) {
        ...
        try {
            String str = DescriptorRenderer.DEBUG_TEXT.render(declarationDescriptor) + Operators.ARRAY_START_STR + declarationDescriptor.getClass().getSimpleName() + "@" + Integer.toHexString(System.identityHashCode(declarationDescriptor)) + Operators.ARRAY_END_STR;
            if (str == null) {
                $$$reportNull$$$0(5);
            }
            return str;
        } catch (Throwable unused) {
            String str2 = declarationDescriptor.getClass().getSimpleName() + Operators.SPACE_STR + declarationDescriptor.getName();
            if (str2 == null) {
                $$$reportNull$$$0(6);
            }
            return str2;

...
public final class CacheByClassKt {
    ...
    static {
        ...
        try {
            ...
            objM326constructorimpl = Result.m326constructorimpl(Class.forName("java.lang.ClassValue"));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM326constructorimpl = Result.m326constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m333isSuccessimpl(objM326constructorimpl)) {
            Result.Companion companion3 = Result.INSTANCE;
            objM326constructorimpl = true;
        }
        Object objM326constructorimpl2 = Result.m326constructorimpl(objM326constructorimpl);
        if (Result.m332isFailureimpl(objM326constructorimpl2)) {
            objM326constructorimpl2 = false;
        }
        useClassValue = ((Boolean) objM326constructorimpl2).booleanValue();
    }

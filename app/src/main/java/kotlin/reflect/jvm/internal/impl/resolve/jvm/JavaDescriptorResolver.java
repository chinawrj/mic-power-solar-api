...
public final class JavaDescriptorResolver {
    ...
    public final ClassDescriptor resolveClass(JavaClass javaClass) {
        ...
        if (outerClass != null) {
            ...
            ClassifierDescriptor contributedClassifier = unsubstitutedInnerClassesScope != null ? unsubstitutedInnerClassesScope.mo1620getContributedClassifier(javaClass.getName(), NoLookupLocation.FROM_JAVA_LOADER) : null;

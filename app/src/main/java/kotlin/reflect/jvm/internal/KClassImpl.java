...
public final class KClassImpl<T> extends KDeclarationContainerImpl implements KClass<T>, KClassifierImpl, KTypeParameterOwnerImpl {
        ...
        public Data() {
            ...
            this.supertypes = ReflectProperties.lazySoft(new Function0<List<? extends KTypeImpl>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2
                ...
                public final List<? extends KTypeImpl> invoke() {
                    Collection<KotlinType> collectionMo1619getSupertypes = this.this$0.getDescriptor().getTypeConstructor().mo1619getSupertypes();
                    Intrinsics.checkNotNullExpressionValue(collectionMo1619getSupertypes, "descriptor.typeConstructor.supertypes");
                    ArrayList arrayList = new ArrayList(collectionMo1619getSupertypes.size());
                    final KClassImpl<T>.Data data = this.this$0;
                    final KClassImpl<T> kClassImpl = kClassImpl;
                    for (final KotlinType kotlinType : collectionMo1619getSupertypes) {
                        ...
                        arrayList.add(new KTypeImpl(kotlinType, new Function0<Type>() { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2$1$1
                            ...
                            public final Type invoke() {
                                ...
                                if (!(classifierDescriptorMo1618getDeclarationDescriptor instanceof ClassDescriptor)) {
                                    throw new KotlinReflectionInternalError("Supertype not a class: " + classifierDescriptorMo1618getDeclarationDescriptor);
                                }
                                Class<?> javaClass = UtilKt.toJavaClass((ClassDescriptor) classifierDescriptorMo1618getDeclarationDescriptor);
                                if (javaClass == null) {
                                    throw new KotlinReflectionInternalError("Unsupported superclass of " + data + ": " + classifierDescriptorMo1618getDeclarationDescriptor);
                                }
                                ...
                                if (iIndexOf < 0) {
                                    throw new KotlinReflectionInternalError("No superclass of " + data + " in Java reflection for " + classifierDescriptorMo1618getDeclarationDescriptor);
                                }
    ...
    public String toString() {
        ...
        sb.append(str + StringsKt.replace$default(strAsString, Operators.DOT, '$', false, 4, (Object) null));
        return sb.toString();
    }

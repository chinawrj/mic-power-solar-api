...
public final class JavaToKotlinClassMap {
    ...
    static {
        ...
        NUMBERED_FUNCTION_PREFIX = FunctionClassKind.Function.getPackageFqName().toString() + Operators.DOT + FunctionClassKind.Function.getClassNamePrefix();
        NUMBERED_K_FUNCTION_PREFIX = FunctionClassKind.KFunction.getPackageFqName().toString() + Operators.DOT + FunctionClassKind.KFunction.getClassNamePrefix();
        NUMBERED_SUSPEND_FUNCTION_PREFIX = FunctionClassKind.SuspendFunction.getPackageFqName().toString() + Operators.DOT + FunctionClassKind.SuspendFunction.getClassNamePrefix();
        NUMBERED_K_SUSPEND_FUNCTION_PREFIX = FunctionClassKind.KSuspendFunction.getPackageFqName().toString() + Operators.DOT + FunctionClassKind.KSuspendFunction.getClassNamePrefix();
        ...
        for (int i2 = 0; i2 < 22; i2++) {
            ...
            INSTANCE.addKotlinToJava(new FqName((functionClassKind.getPackageFqName().toString() + Operators.DOT + functionClassKind.getClassNamePrefix()) + i2), K_FUNCTION_CLASS_ID);
        }

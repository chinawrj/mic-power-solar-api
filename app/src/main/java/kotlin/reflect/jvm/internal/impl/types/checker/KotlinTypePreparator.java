    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> collectionMo1619getSupertypes = capturedTypeConstructorImpl.mo1619getSupertypes();
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> collectionMo1619getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo1619getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo1619getSupertypes2, 10));
            Iterator<T> it2 = collectionMo1619getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> collectionMo1619getSupertypes3 = intersectionTypeConstructor.mo1619getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt.collectionSizeOrDefault(collectionMo1619getSupertypes3, 10));
        Iterator<T> it3 = collectionMo1619getSupertypes3.iterator();
        while (it3.hasNext()) {

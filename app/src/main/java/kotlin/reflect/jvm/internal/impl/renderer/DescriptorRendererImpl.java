...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    private final String lt() {
        return escape(Operators.L);
    }

    private final String gt() {
        return escape(Operators.G);
    }
    ...
    public String renderFlexibleType(String lowerRendered, String upperRendered, KotlinBuiltIns builtIns) {
        ...
        if (RenderingUtilsKt.typeStringsDifferOnlyInNullability(lowerRendered, upperRendered)) {
            if (StringsKt.startsWith$default(upperRendered, Operators.BRACKET_START_STR, false, 2, (Object) null)) {
        ...
        return Operators.BRACKET_START_STR + lowerRendered + PdrUtil.FILE_PATH_ENTRY_BACK + upperRendered + Operators.BRACKET_END;
    }
    ...
    */
    ...
    public String renderTypeConstructor(TypeConstructor typeConstructor) {
        ...
        if (classifierDescriptorMo1618getDeclarationDescriptor instanceof TypeParameterDescriptor ? true : classifierDescriptorMo1618getDeclarationDescriptor instanceof ClassDescriptor ? true : classifierDescriptorMo1618getDeclarationDescriptor instanceof TypeAliasDescriptor) {
            return renderClassifierName(classifierDescriptorMo1618getDeclarationDescriptor);
        }
        if (classifierDescriptorMo1618getDeclarationDescriptor == null) {
        ...
        throw new IllegalStateException(("Unexpected classifier: " + classifierDescriptorMo1618getDeclarationDescriptor.getClass()).toString());
    }
    ...
    public String renderAnnotation(AnnotationDescriptor annotation, AnnotationUseSiteTarget annotationUseSiteTarget) {
        ...
        if (annotationUseSiteTarget != null) {
            sb.append(annotationUseSiteTarget.getRenderName() + Operators.CONDITION_IF_MIDDLE);
        }
        ...
        if (getIncludeAnnotationArguments()) {
            ...
            if (getIncludeEmptyAnnotationArguments() || !listRenderAndSortAnnotationArguments.isEmpty()) {
                CollectionsKt.joinTo$default(listRenderAndSortAnnotationArguments, sb, ", ", Operators.BRACKET_START_STR, Operators.BRACKET_END_STR, 0, null, null, 112, null);
            }
        }
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo1618getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ClassConstructorDescriptor classConstructorDescriptorMo1612getUnsubstitutedPrimaryConstructor;
        ...
        if (annotationClass != null && (classConstructorDescriptorMo1612getUnsubstitutedPrimaryConstructor = annotationClass.mo1612getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = classConstructorDescriptorMo1612getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
    ...
    public final String renderConstant(ConstantValue<?> constantValue) {
        if (constantValue instanceof ArrayValue) {
            return CollectionsKt.joinToString$default(((ArrayValue) constantValue).getValue(), ", ", Operators.BLOCK_START_STR, Operators.BLOCK_END_STR, 0, null, new Function1<ConstantValue<?>, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl.renderConstant.1
                {
                    super(1);
                }
    ...
    private final void renderAdditionalModifiers(FunctionDescriptor functionDescriptor, StringBuilder sb) {
        ...
        renderModifier(sb, functionDescriptor.isInline(), AbsoluteConst.JSON_VALUE_INLINE);
    ...
    private final String renderForReceiver(KotlinType kotlinType) {
        ...
        return Operators.BRACKET_START_STR + strRenderType + Operators.BRACKET_END;
    }
    ...
    */
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ConstantValue<?> constantValueMo1614getCompileTimeInitializer;
        if (!getIncludePropertyConstant() || (constantValueMo1614getCompileTimeInitializer = variableDescriptor.mo1614getCompileTimeInitializer()) == null) {
            return;
        }
        sb.append(" = ");
        sb.append(escape(renderConstant(constantValueMo1614getCompileTimeInitializer)));
    }
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        if (!getStartFromName()) {
            ...
            renderModifier(sb, getModifiers().contains(DescriptorRendererModifier.INLINE) && classDescriptor.isInline(), AbsoluteConst.JSON_VALUE_INLINE);
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (classConstructorDescriptorMo1612getUnsubstitutedPrimaryConstructor = classDescriptor.mo1612getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(Operators.SPACE_STR);
            renderAnnotations$default(this, sb, classConstructorDescriptorMo1612getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = classConstructorDescriptorMo1612getUnsubstitutedPrimaryConstructor.getVisibility();
            ...
            renderValueParameters(valueParameters, classConstructorDescriptorMo1612getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        Collection<KotlinType> collectionMo1619getSupertypes = classDescriptor.getTypeConstructor().mo1619getSupertypes();
        Intrinsics.checkNotNullExpressionValue(collectionMo1619getSupertypes, "klass.typeConstructor.supertypes");
        if (collectionMo1619getSupertypes.isEmpty()) {
            return;
        }
        if (collectionMo1619getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(collectionMo1619getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt.joinTo$default(collectionMo1619getSupertypes, sb, ", ", null, null, 0, null, new Function1<KotlinType, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl.renderSuperTypes.1
            {
                super(1);
            }

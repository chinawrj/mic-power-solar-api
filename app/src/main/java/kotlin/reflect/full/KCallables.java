...
public final class KCallables {
    ...
    /* compiled from: KCallables.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "kotlin.reflect.full.KCallables", f = "KCallables.kt", i = {0, 0, 0}, l = {IMgr.WindowEvent.WINDOW_BACKGROUND_SET_WEBPARENT}, m = "callSuspendBy", n = {"$this$callSuspendBy", "args", "kCallable"}, s = {"L$0", "L$1", "L$2"})
    /* renamed from: kotlin.reflect.full.KCallables$callSuspendBy$1, reason: invalid class name and case insensitive filesystem */
    static final class C01311<R> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        int label;
    ...
    */
    public static final <R> java.lang.Object callSuspendBy(kotlin.reflect.KCallable<? extends R> r4, java.util.Map<kotlin.reflect.KParameter, ? extends java.lang.Object> r5, kotlin.coroutines.Continuation<? super R> r6) throws kotlin.reflect.full.IllegalCallableAccessException {
        /*
            boolean r0 = r6 instanceof kotlin.reflect.full.KCallables.C01311
            if (r0 == 0) goto L14
            r0 = r6
            kotlin.reflect.full.KCallables$callSuspendBy$1 r0 = (kotlin.reflect.full.KCallables.C01311) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14

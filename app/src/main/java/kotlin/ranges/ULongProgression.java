...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1546getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM501constructorimpl = ((int) ULong.m501constructorimpl(j ^ ULong.m501constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM501constructorimpl2 = (iM501constructorimpl + ((int) ULong.m501constructorimpl(j2 ^ ULong.m501constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return iM501constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m547toStringimpl(this.first));
            sb.append(PdrUtil.FILE_PATH_ENTRY_BACK);
            sb.append((Object) ULong.m547toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1572fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {

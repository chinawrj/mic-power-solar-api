...
public final class FileTreeWalk implements Sequence<File> {
    ...
    public final FileTreeWalk maxDepth(int depth) {
        if (depth <= 0) {
            throw new IllegalArgumentException("depth must be positive, but was " + depth + Operators.DOT);
        }

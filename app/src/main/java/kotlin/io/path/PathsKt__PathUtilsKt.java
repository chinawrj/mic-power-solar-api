...
class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static final String getNameWithoutExtension(Path path) {
        ...
        Intrinsics.checkNotNullParameter(path, "<this>");
        Path fileName = path.getFileName();
        return (fileName == null || (string = fileName.toString()) == null || (strSubstringBeforeLast$default = StringsKt.substringBeforeLast$default(string, Operators.DOT_STR, (String) null, 2, (Object) null)) == null) ? "" : strSubstringBeforeLast$default;
    }
    ...
    public static final String getExtension(Path path) {
        ...
        Intrinsics.checkNotNullParameter(path, "<this>");
        Path fileName = path.getFileName();
        return (fileName == null || (string = fileName.toString()) == null || (strSubstringAfterLast = StringsKt.substringAfterLast(string, Operators.DOT, "")) == null) ? "" : strSubstringAfterLast;
    }
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesView(Path path, LinkOption... options) {
        ...
        if (fileAttributeView != null) {
            return (V) StreamsKt$$ExternalSyntheticApiModelOutline0.m1656m((Object) fileAttributeView);
        }
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
    ...
    public static final Void fileAttributeViewNotAvailable(Path path, Class<?> attributeViewClass) {
        ...
        throw new UnsupportedOperationException("The desired attribute view type " + attributeViewClass + " is not available for the file " + path + Operators.DOT);
    }
    ...
    private static final /* synthetic */ <A extends BasicFileAttributes> A readAttributes(Path path, LinkOption... options) throws IOException {
        ...
        BasicFileAttributes attributes = Files.readAttributes(path, (Class<BasicFileAttributes>) Okio$$ExternalSyntheticApiModelOutline0.m247m(), (LinkOption[]) Arrays.copyOf(options, options.length));
        Intrinsics.checkNotNullExpressionValue(attributes, "readAttributes(this, A::class.java, *options)");
        return (A) StreamsKt$$ExternalSyntheticApiModelOutline0.m1654m((Object) attributes);
    }

...
class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
        ...
        if ((i & 2) != 0) {
            function3 = new Function3() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.1
                ...
                public /* bridge */ /* synthetic */ Object invoke(Object obj2, Object obj3, Object obj4) {
                    return invoke(Okio$$ExternalSyntheticApiModelOutline0.m258m(obj2), Okio$$ExternalSyntheticApiModelOutline0.m258m(obj3), (Exception) obj4);
                }
        ...
        if (z2) {
            return PathsKt.copyToRecursively(path, target, onError, z, new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.2
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path2, Path path3) {
                    return invoke2(copyActionContext, Okio$$ExternalSyntheticApiModelOutline0.m258m((Object) path2), Okio$$ExternalSyntheticApiModelOutline0.m258m((Object) path3));
                }
        ...
        if ((i & 8) != 0) {
            function32 = new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.4
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path3, Path path4) {
                    return invoke2(copyActionContext, Okio$$ExternalSyntheticApiModelOutline0.m258m((Object) path3), Okio$$ExternalSyntheticApiModelOutline0.m258m((Object) path4));
                }
    ...
    public static final Path copyToRecursively(final Path path, final Path target, final Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> onError, boolean z, final Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> copyAction) throws FileSystemException {
        ...
        if (!Files.exists(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))) {
            StreamsKt$$ExternalSyntheticApiModelOutline0.m1664m();
            throw StreamsKt$$ExternalSyntheticApiModelOutline0.m1650m(path.toString(), target.toString(), "The source file doesn't exist.");
        }
        ...
        if (Files.exists(path, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) && (z || !Files.isSymbolicLink(path))) {
            ...
            if (!z2 || !Files.isSameFile(path, target)) {
                ...
                if (zStartsWith) {
                    Okio$$ExternalSyntheticApiModelOutline0.m$4();
        ...
        PathsKt.visitFileTree$default(path, 0, z, new Function1<FileVisitorBuilder, Unit>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.5
            ...
            /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function2<Path, BasicFileAttributes, FileVisitResult> {
                ...
                public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path, BasicFileAttributes basicFileAttributes) {
                    return invoke2(Okio$$ExternalSyntheticApiModelOutline0.m258m((Object) path), StreamsKt$$ExternalSyntheticApiModelOutline0.m1654m((Object) basicFileAttributes));
                }
            ...
            public final void invoke2(FileVisitorBuilder visitFileTree) {
                ...
                visitFileTree.onPostVisitDirectory(new Function2<Path, IOException, FileVisitResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.5.4
                    ...
                    public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path4, IOException iOException) {
                        return invoke2(Okio$$ExternalSyntheticApiModelOutline0.m258m((Object) path4), iOException);
                    }
            ...
            /* synthetic */ class AnonymousClass3 extends FunctionReferenceImpl implements Function2<Path, Exception, FileVisitResult> {
                ...
                public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path, Exception exc) {
                    return invoke2(Okio$$ExternalSyntheticApiModelOutline0.m258m((Object) path), exc);
                }
    ...
    public static final void deleteRecursively(Path path) throws IOException {
        ...
        FileSystemException fileSystemExceptionM = Okio$$ExternalSyntheticApiModelOutline0.m("Failed to delete one or more files. See suppressed exceptions for details.");
    ...
    private static final List<Exception> deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(Path path) throws IOException {
        ...
        if (parent != null) {
            ...
            if (directoryStreamNewDirectoryStream != null) {
                ...
                try {
                    DirectoryStream directoryStreamM = StreamsKt$$ExternalSyntheticApiModelOutline0.m((Object) directoryStream);
                    if (StreamsKt$$ExternalSyntheticApiModelOutline0.m1666m((Object) directoryStreamM)) {
                        exceptionsCollector.setPath(parent);
                        SecureDirectoryStream secureDirectoryStreamM1652m = StreamsKt$$ExternalSyntheticApiModelOutline0.m1652m((Object) directoryStreamM);
                        Path fileName = path.getFileName();
                        Intrinsics.checkNotNullExpressionValue(fileName, "this.fileName");
                        handleEntry$PathsKt__PathRecursiveFunctionsKt(secureDirectoryStreamM1652m, fileName, exceptionsCollector);
                    } else {
                        z = true;
                    }
    ...
    private static final void enterDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, ExceptionsCollector exceptionsCollector) throws IOException {
        ...
        try {
            ...
            try {
                SecureDirectoryStream secureDirectoryStreamM1652m = StreamsKt$$ExternalSyntheticApiModelOutline0.m1652m((Object) secureDirectoryStream2);
                Iterator it = secureDirectoryStreamM1652m.iterator();
                while (it.hasNext()) {
                    Path fileName = Okio$$ExternalSyntheticApiModelOutline0.m258m(it.next()).getFileName();
    ...
    private static final boolean isDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, LinkOption... linkOptionArr) {
        Boolean boolValueOf;
        try {
            boolValueOf = Boolean.valueOf(Okio$$ExternalSyntheticApiModelOutline0.m261m((Object) secureDirectoryStream.getFileAttributeView(path, Okio$$ExternalSyntheticApiModelOutline0.m$1(), (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))).readAttributes().isDirectory());
        } catch (NoSuchFileException unused) {
            boolValueOf = null;
        }
        if (boolValueOf != null) {
    ...
    private static final void insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(Path path, ExceptionsCollector exceptionsCollector) throws IOException {
        ...
        try {
            ...
            DirectoryStream directoryStream = directoryStreamNewDirectoryStream;
            try {
                Iterator it = StreamsKt$$ExternalSyntheticApiModelOutline0.m((Object) directoryStream).iterator();
                while (it.hasNext()) {
                    Path entry = Okio$$ExternalSyntheticApiModelOutline0.m258m(it.next());

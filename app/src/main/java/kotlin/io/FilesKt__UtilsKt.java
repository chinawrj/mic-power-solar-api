...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final File createTempDir(String prefix, String str, File file) throws IOException {
        ...
        throw new IOException("Unable to create temporary directory " + dir + Operators.DOT);
    }
    ...
    private static final List<File> normalize$FilesKt__UtilsKt(List<? extends File> list) {
        ...
        for (File file : list) {
            ...
            if (!Intrinsics.areEqual(name, Operators.DOT_STR)) {
                if (Intrinsics.areEqual(name, PdrUtil.FILE_PATH_ENTRY_BACK)) {
                    if (arrayList.isEmpty() || Intrinsics.areEqual(((File) CollectionsKt.last((List) arrayList)).getName(), PdrUtil.FILE_PATH_ENTRY_BACK)) {
                        arrayList.add(file);
                    } else {

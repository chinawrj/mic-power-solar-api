...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1837boximpl(m1831markNowz9LOYto());
    }
    ...
    public long m1831markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1840constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m1830elapsedFrom6eNON_k(long timeMark) {
        return LongSaturatedMathKt.saturatingDiff(read(), timeMark);
    }

    /* renamed from: differenceBetween-fRLX17w, reason: not valid java name */
    public final long m1829differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m1828adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1840constructorimpl(LongSaturatedMathKt.m1826saturatingAddpTJri5U(timeMark, duration));
    }
}

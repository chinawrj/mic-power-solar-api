...
public abstract class BleScanPresenter implements BluetoothAdapter.LeScanCallback {
    ...
    */
    private void checkDevice(com.clj.fastble.data.BleDevice r9) {
        /*
            r8 = this;
        ...
        L63:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.clj.fastble.scan.BleScanPresenter.checkDevice(com.clj.fastble.data.BleDevice):void");
    }

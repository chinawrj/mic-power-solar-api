...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, T t, int i) throws Resources.NotFoundException {
            int iRound;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Override // com.google.android.material.appbar.HeaderBehavior
        public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, T t, int i, int i2, int i3) throws Resources.NotFoundException {
            int topBottomOffsetForScrollingSibling = getTopBottomOffsetForScrollingSibling();
            int i4 = 0;
        ...
        private void updateAppBarLayoutDrawableState(CoordinatorLayout coordinatorLayout, T t, int i, int i2, boolean z) throws Resources.NotFoundException {

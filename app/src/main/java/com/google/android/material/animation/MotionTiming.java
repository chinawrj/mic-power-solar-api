...
public class MotionTiming {
    ...
    public String toString() {
        return "\n" + getClass().getName() + Operators.BLOCK_START + Integer.toHexString(System.identityHashCode(this)) + " delay: " + getDelay() + " duration: " + getDuration() + " interpolator: " + getInterpolator().getClass() + " repeatCount: " + getRepeatCount() + " repeatMode: " + getRepeatMode() + "}\n";
    }
}

...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    void onElevationsChanged(float f, float f2, float f3) {
        ...
        arrayList.add(ObjectAnimator.ofFloat(this.view, Constants.Name.ELEVATION, f).setDuration(0L));
    ...
    private Animator createElevationAnimator(float f, float f2) {
        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.play(ObjectAnimator.ofFloat(this.view, Constants.Name.ELEVATION, f).setDuration(0L)).with(ObjectAnimator.ofFloat(this.view, (Property<FloatingActionButton, Float>) View.TRANSLATION_Z, f2).setDuration(100L));
        animatorSet.setInterpolator(ELEVATION_ANIM_INTERPOLATOR);
        return animatorSet;
    }

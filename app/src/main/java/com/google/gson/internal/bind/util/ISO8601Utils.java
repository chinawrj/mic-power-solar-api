    ...
    public static Date parse(String str, ParsePosition parsePosition) throws ParseException {
        ...
        try {
            ...
            if (zCheckOffset) {
                ...
                if (checkOffset(str, i11, Operators.CONDITION_IF_MIDDLE)) {
                    i11 = i7 + 6;
                }
                int i13 = i11 + 2;
                int i14 = parseInt(str, i11, i13);
                if (checkOffset(str, i13, Operators.CONDITION_IF_MIDDLE)) {
                    i13 = i11 + 3;
                }
                if (str.length() <= i13 || (cCharAt = str.charAt(i13)) == 'Z' || cCharAt == '+' || cCharAt == '-') {
                    ...
                    if (checkOffset(str, i15, Operators.DOT)) {
                        int i16 = i13 + 3;
            ...
            if (str == null) {
                ...
                str2 = JSUtil.QUOTE + str + '\"';
            }
            String message = e.getMessage();
            if (message == null || message.isEmpty()) {
                message = Operators.BRACKET_START_STR + e.getClass().getName() + Operators.BRACKET_END_STR;
            }

...
public class Glide implements ComponentCallbacks2 {
    ...
    private static void checkAndInitializeGlide(Context context) throws PackageManager.NameNotFoundException {
        if (isInitializing) {
    ...
    private static void initializeGlide(Context context) throws PackageManager.NameNotFoundException {
        initializeGlide(context, new GlideBuilder());
    }

    private static void initializeGlide(Context context, GlideBuilder glideBuilder) throws PackageManager.NameNotFoundException {
    ...
    private static GeneratedAppGlideModule getAnnotationGeneratedGlideModules() {
        try {
            return (GeneratedAppGlideModule) Class.forName("com.bumptech.glide.GeneratedAppGlideModuleImpl").getDeclaredConstructor(null).newInstance(null);

    ...
    public void displayImage(String str, ImageAware imageAware, DisplayImageOptions displayImageOptions, ImageLoadingListener imageLoadingListener) {
        ...
        if (bitmap != null && !bitmap.isRecycled()) {
            ...
            if (displayImageOptions.shouldPostProcess()) {
                ProcessAndDisplayImageTask processAndDisplayImageTask = new ProcessAndDisplayImageTask(this.engine, bitmap, new ImageLoadingInfo(str, imageAware, imageSizeDefineTargetSizeForView, strGenerateKey, displayImageOptions, imageLoadingListener2, this.engine.getLockForUri(str)), displayImageOptions.getHandler());
        ...
        LoadAndDisplayImageTask loadAndDisplayImageTask = new LoadAndDisplayImageTask(this.engine, new ImageLoadingInfo(str, imageAware, imageSizeDefineTargetSizeForView, strGenerateKey, displayImageOptions, imageLoadingListener2, this.engine.getLockForUri(str)), displayImageOptions.getHandler());
        if (displayImageOptions.isSyncLoading()) {

...
public class MiscCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    private static boolean FILE_RELATIVE_PATH_SUPPORT = AbsoluteConst.TRUE.equals(IOUtils.getStringProperty("fastjson.deserializer.fileRelativePathSupport"));
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int i) throws TransformerException, IOException {
        ...
        if (cls == SimpleDateFormat.class) {
            ...
            if (serializeWriter.isEnabled(SerializerFeature.WriteClassName) && obj.getClass() != type) {
                ...
                serializeWriter.writeFieldValue(Operators.ARRAY_SEPRATOR, "val", string);
                ...
                if (obj instanceof Map.Entry) {
                    ...
                    if (key instanceof String) {
                        ...
                        if (value instanceof String) {
                            serializeWriter.writeFieldValueStringWithDoubleQuoteCheck(Operators.BLOCK_START, str, (String) value);
                        } else {
                            serializeWriter.write(123);
    ...
    public <T> T deserialze(DefaultJSONParser defaultJSONParser, Type type, Object obj) {
        ...
        if (type == InetSocketAddress.class) {
            ...
            if (type == File.class) {
                if (str.indexOf(PdrUtil.FILE_PATH_ENTRY_BACK) >= 0 && !FILE_RELATIVE_PATH_SUPPORT) {

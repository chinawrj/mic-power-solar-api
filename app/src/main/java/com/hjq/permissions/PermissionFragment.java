...
public final class PermissionFragment extends Fragment implements Runnable {
    ...
    class AnonymousClass2 implements OnPermissionCallback {
            ...
            if (z && PermissionFragment.this.isAdded()) {
                ...
                PermissionUtils.postDelayed(new Runnable() { // from class: com.hjq.permissions.PermissionFragment$2$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m231lambda$onGranted$0$comhjqpermissionsPermissionFragment$2(activity, arrayList, list2, i);
                    }
                }, j);
            }
        }
        ...
        /* synthetic */ void m231lambda$onGranted$0$comhjqpermissionsPermissionFragment$2(Activity activity, final ArrayList arrayList, final List list, final int i) {

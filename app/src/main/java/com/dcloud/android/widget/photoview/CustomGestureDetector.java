...
class CustomGestureDetector {
    ...
    CustomGestureDetector(Context context, OnGestureListener onGestureListener) {
        ...
        this.mDetector = new ScaleGestureDetector(context, new ScaleGestureDetector.OnScaleGestureListener() { // from class: com.dcloud.android.widget.photoview.CustomGestureDetector.1

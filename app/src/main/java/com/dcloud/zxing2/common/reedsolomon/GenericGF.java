...
public final class GenericGF {
    ...
    static {
        ...
        GenericGF genericGF2 = new GenericGF(ConnectError.BLE_CONNECTED, 256, 1);
    ...
    public String toString() {
        return "GF(0x" + Integer.toHexString(this.primitive) + Operators.ARRAY_SEPRATOR + this.size + Operators.BRACKET_END;
    }
}

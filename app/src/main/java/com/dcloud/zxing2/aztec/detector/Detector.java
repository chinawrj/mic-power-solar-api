    ...
    private ResultPoint[] getBullsEyeCorners(Point point) throws NotFoundException {
        ...
        while (this.nbCenterLayers < 9) {
            ...
            if (this.nbCenterLayers > 2) {
                double dDistance = (distance(firstDifferent4, firstDifferent) * this.nbCenterLayers) / (distance(point, point4) * (this.nbCenterLayers + 2));
        ...
        this.compact = i == 5;
        return expandSquare(new ResultPoint[]{new ResultPoint(point4.getX() + 0.5f, point4.getY() - 0.5f), new ResultPoint(point3.getX() + 0.5f, point3.getY() + 0.5f), new ResultPoint(point2.getX() - 0.5f, point2.getY() + 0.5f), new ResultPoint(point.getX() - 0.5f, point.getY() - 0.5f)}, r0 - 3, this.nbCenterLayers * 2);
    }

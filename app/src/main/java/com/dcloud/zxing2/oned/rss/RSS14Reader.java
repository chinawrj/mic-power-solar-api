...
public final class RSS14Reader extends AbstractRSSReader {
  ...
  0x0054: PHI (r8v11 boolean) = (r8v2 boolean), (r8v14 boolean) binds: [B:32:0x004f, B:20:0x0037] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    private void adjustOddEvenCounts(boolean r10, int r11) throws com.dcloud.zxing2.NotFoundException {
        /*
            Method dump skipped, instructions count: 230
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dcloud.zxing2.oned.rss.RSS14Reader.adjustOddEvenCounts(boolean, int):void");
    }
    ...
    private DataCharacter decodeDataCharacter(BitArray bitArray, FinderPattern finderPattern, boolean z) throws NotFoundException {
        ...
        int i3 = z ? 16 : 15;
        float fCount = AbstractRSSReader.count(dataCharacterCounters) / i3;

...
public class WXParams implements Serializable {
    ...
    public String getCrashFilePath() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    public String getLibIcuPath() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    public String getLibJscPath() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        WXLogUtils.d("getLibJscPath is running " + this.libJscPath);
        return this.libJscPath;
    }

    public String getLibJssPath() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {

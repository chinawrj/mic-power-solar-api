...
public interface IWXBridge extends IWXObject {
    ...
    int callAddChildToRichtext(String str, String str2, String str3, String str4, String str5, HashMap<String, String> map, HashMap<String, String> map2);

    int callAddElement(String str, String str2, String str3, int i, String str4, HashMap<String, String> map, HashMap<String, String> map2, HashSet<String> hashSet, float[] fArr, float[] fArr2, float[] fArr3, boolean z);

    int callAddEvent(String str, String str2, String str3);

    int callAppendTreeCreateFinish(String str, String str2);

    void callBacthEnd(String str);

    void callBacthStart(String str);

    int callCreateBody(String str, String str2, String str3, HashMap<String, String> map, HashMap<String, String> map2, HashSet<String> hashSet, float[] fArr, float[] fArr2, float[] fArr3);

    int callCreateFinish(String str);

    int callHasTransitionPros(String str, String str2, HashMap<String, String> map);
    ...
    int callUpdateAttrs(String str, String str2, HashMap<String, String> map);

    int callUpdateFinish(String str, byte[] bArr, String str2);

    int callUpdateRichtextChildAttr(String str, String str2, HashMap<String, String> map, String str3, String str4);

    int callUpdateRichtextStyle(String str, String str2, HashMap<String, String> map, String str3, String str4);

    int callUpdateStyle(String str, String str2, HashMap<String, Object> map, HashMap<String, String> map2, HashMap<String, String> map3, HashMap<String, String> map4);

    void callVueExec(String str, String str2, String str3);

    Object callVueExecSync(String str, String str2, String str3);
    ...
    void setStyleHeight(String str, String str2, float f, boolean z);

    void setStyleWidth(String str, String str2, float f);

    void setStyleWidth(String str, String str2, float f, boolean z);

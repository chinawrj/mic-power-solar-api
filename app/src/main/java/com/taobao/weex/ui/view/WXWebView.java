...
public class WXWebView implements IWebView {
    ...
    private void initWebView(WebView webView) {
        ...
        webView.setWebViewClient(new WebViewClient() { // from class: com.taobao.weex.ui.view.WXWebView.1
            ...
            @Override // android.webkit.WebViewClient
            public boolean shouldOverrideUrlLoading(WebView webView2, String str) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        webView.setWebChromeClient(new WebChromeClient() { // from class: com.taobao.weex.ui.view.WXWebView.2
            ...
            public boolean onJsPrompt(WebView webView2, String str, String str2, String str3, JsPromptResult jsPromptResult) {
                ...
                if (!TextUtils.equals(uri.getScheme(), WXWebView.BRIDGE_NAME)) {
                    return super.onJsPrompt(webView2, str, str2, str3, jsPromptResult);
                }
                if (!TextUtils.equals(uri.getAuthority(), WXWeb.POST_MESSAGE)) {
                    jsPromptResult.confirm(Constants.Event.FAIL);
                    return true;
                }
                WXWebView.this.onMessage(uri.getQueryParameter("message"), uri.getQueryParameter("targetOrigin"));
                jsPromptResult.confirm(WXImage.SUCCEED);
                return true;
            }

            @Override // android.webkit.WebChromeClient
            public void onProgressChanged(WebView webView2, int i) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {

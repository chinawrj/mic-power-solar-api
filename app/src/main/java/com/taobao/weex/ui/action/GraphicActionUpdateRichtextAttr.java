...
public class GraphicActionUpdateRichtextAttr extends BasicGraphicAction {
    public GraphicActionUpdateRichtextAttr(WXSDKInstance wXSDKInstance, String str, HashMap<String, String> map, String str2, String str3) {
        ...
        if (wXRichText != null) {
            ...
            map2.putAll(map);
            wXRichText.updateChildNodeAttrs(str, map2);
        }
    }

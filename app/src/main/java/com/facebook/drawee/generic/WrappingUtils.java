...
public class WrappingUtils {
    ...
    static ScaleTypeDrawable wrapChildWithScaleType(DrawableParent parent, ScalingUtils.ScaleType scaleType) {
        Drawable drawableMaybeWrapWithScaleType = maybeWrapWithScaleType(parent.setDrawable(sEmptyDrawable), scaleType);
        parent.setDrawable(drawableMaybeWrapWithScaleType);
    ...
    static void updateLeafRounding(DrawableParent parent, @Nullable RoundingParams roundingParams, Resources resources) {
        DrawableParent drawableParentFindDrawableParentForLeaf = findDrawableParentForLeaf(parent);

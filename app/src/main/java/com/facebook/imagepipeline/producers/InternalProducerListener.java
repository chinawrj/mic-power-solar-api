...
public class InternalProducerListener implements ProducerListener2 {
    ...
    public boolean requiresExtraMap(ProducerContext context, String producerName) {
        ...
        ProducerListener producerListener = this.mProducerListener;
        boolean zRequiresExtraMap = producerListener != null ? producerListener.requiresExtraMap(context.getId()) : false;
        return (zRequiresExtraMap || (producerListener2 = this.mProducerListener2) == null) ? zRequiresExtraMap : producerListener2.requiresExtraMap(context, producerName);
    }
}

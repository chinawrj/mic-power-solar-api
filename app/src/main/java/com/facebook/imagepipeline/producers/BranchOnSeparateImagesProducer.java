...
public class BranchOnSeparateImagesProducer implements Producer<EncodedImage> {
    ...
    private class OnFirstImageConsumer extends DelegatingConsumer<EncodedImage, EncodedImage> {
        ...
        public void onNewResultImpl(@Nullable EncodedImage newResult, int status) throws IOException {
            ...
            boolean zIsImageBigEnough = ThumbnailSizeChecker.isImageBigEnough(newResult, imageRequest.getResizeOptions());
            if (newResult != null && (zIsImageBigEnough || imageRequest.getLocalThumbnailPreviewsEnabled())) {

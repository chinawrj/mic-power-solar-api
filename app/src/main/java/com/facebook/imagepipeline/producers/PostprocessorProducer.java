...
public class PostprocessorProducer implements Producer<CloseableReference<CloseableImage>> {
    ...
    private class PostprocessorConsumer extends DelegatingConsumer<CloseableReference<CloseableImage>, CloseableReference<CloseableImage>> {
        ...
        public void doPostprocessing(CloseableReference<CloseableImage> sourceImageRef, int status) {
            ...
            try {
                try {
                    CloseableReference<CloseableImage> closeableReferencePostprocessInternal = postprocessInternal(sourceImageRef.get());
                    ...
                    maybeNotifyOnNewResult(closeableReferencePostprocessInternal, status);
        ...
        private CloseableReference<CloseableImage> postprocessInternal(CloseableImage sourceImage) {
            ...
            try {
                CloseableStaticBitmap closeableStaticBitmap2 = new CloseableStaticBitmap(closeableReferenceProcess, sourceImage.getQualityInfo(), closeableStaticBitmap.getRotationAngle(), closeableStaticBitmap.getExifOrientation());

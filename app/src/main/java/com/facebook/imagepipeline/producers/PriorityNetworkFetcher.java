...
public class PriorityNetworkFetcher<FETCH_STATE extends FetchState> implements NetworkFetcher<PriorityFetchState<FETCH_STATE>> {
    ...
    public Map<String, String> getExtraMap(PriorityFetchState<FETCH_STATE> fetchState, int byteSize) {
        ...
        map.put("pri_queue_time", "" + (fetchState.dequeuedTimestamp - fetchState.enqueuedTimestamp));
        map.put("hipri_queue_size", "" + fetchState.hiPriCountWhenCreated);
        map.put("lowpri_queue_size", "" + fetchState.lowPriCountWhenCreated);
        map.put("requeueCount", "" + fetchState.requeueCount);
        map.put("priority_changed_count", "" + fetchState.priorityChangedCount);
        map.put("request_initial_priority_is_high", "" + fetchState.isInitialPriorityHigh);
        map.put("currently_fetching_size", "" + fetchState.currentlyFetchingCountWhenCreated);
        map.put("delay_count", "" + fetchState.delayCount);
        return map;
    }
}

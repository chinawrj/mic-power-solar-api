...
public abstract class BasePostprocessor implements Postprocessor {
    ...
    public CloseableReference<Bitmap> process(Bitmap sourceBitmap, PlatformBitmapFactory bitmapFactory) {
        ...
        CloseableReference<Bitmap> closeableReferenceCreateBitmapInternal = bitmapFactory.createBitmapInternal(width, height, config);
        try {
            process(closeableReferenceCreateBitmapInternal.get(), sourceBitmap);
    ...
    private static void internalCopyBitmap(Bitmap destBitmap, Bitmap sourceBitmap) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {

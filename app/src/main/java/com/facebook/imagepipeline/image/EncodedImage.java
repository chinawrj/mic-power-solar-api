...
public class EncodedImage implements Closeable {
    ...
    public EncodedImage(CloseableReference<PooledByteBuffer> pooledByteBufferRef) {
        ...
        this.mPooledByteBufferRef = pooledByteBufferRef.mo190clone();
    ...
    */
    ...
    public ImageFormat getImageFormat() throws IOException {
        parseMetadataIfNeeded();
        return this.mImageFormat;
    }

    public int getRotationAngle() throws IOException {
        parseMetadataIfNeeded();
    ...
    @Nullable
    public ColorSpace getColorSpace() throws IOException {
        parseMetadataIfNeeded();
    ...
    public String getFirstBytesAsHexString(int length) {
        ...
        int iMin = Math.min(getSize(), length);
    ...
    private void parseMetadataIfNeeded() throws IOException {
    ...
    private void internalParseMetaData() throws IOException {
    ...
    @Nullable
    private Pair<Integer, Integer> readWebPImageSize() throws IOException {

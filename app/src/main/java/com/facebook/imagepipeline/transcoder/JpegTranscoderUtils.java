...
public class JpegTranscoderUtils {
    ...
    public static int getSoftwareNumerator(RotationOptions rotationOptions, @Nullable ResizeOptions resizeOptions, EncodedImage encodedImage, boolean resizingEnabled) throws IOException {
    ...
    public static int getRotationAngle(RotationOptions rotationOptions, EncodedImage encodedImage) throws IOException {
        if (!rotationOptions.rotationEnabled()) {
            return 0;
        }
        int iExtractOrientationFromMetadata = extractOrientationFromMetadata(encodedImage);
    ...
    public static int getForceRotatedInvertedExifOrientation(RotationOptions rotationOptions, EncodedImage encodedImage) throws IOException {
        ...
        return immutableList.get((iIndexOf + ((!rotationOptions.useImageMetadata() ? rotationOptions.getForcedAngle() : 0) / 90)) % immutableList.size()).intValue();
    }
    ...
    private static int extractOrientationFromMetadata(EncodedImage encodedImage) throws IOException {

    ...
    public ImagePipeline getImagePipeline() {
        if (sForceSinglePipelineInstance) {
            if (sImagePipeline == null) {
                ImagePipeline imagePipelineCreateImagePipeline = createImagePipeline();
                sImagePipeline = imagePipelineCreateImagePipeline;
                this.mImagePipeline = imagePipelineCreateImagePipeline;
            }

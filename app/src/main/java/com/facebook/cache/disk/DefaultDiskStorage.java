...
public class DefaultDiskStorage implements DiskStorage {
    ...
    private static boolean isExternal(File directory, CacheErrorLogger cacheErrorLogger) throws IOException {
    ...
    private DiskStorage.DiskDumpInfoEntry dumpCacheEntry(DiskStorage.Entry entry) throws IOException {
        ...
        if (strTypeOfBytes.equals(Constants.Name.UNDEFINED) && bArr.length >= 4) {
    ...
    private static class FileInfo {
        ...
        public File createTempFile(File parent) throws IOException {
            return File.createTempFile(this.resourceId + Operators.DOT_STR, ".tmp", parent);
        }

...
public class WebpUtil {
    ...
    @Nullable
    public static Pair<Integer, Integer> getSize(InputStream is) throws IOException {
    ...
    private static Pair<Integer, Integer> getVP8LDimension(final InputStream is) throws IOException {
        ...
        int i = ((byte) is.read()) & 255;
        byte b = (byte) is.read();
        return new Pair<>(Integer.valueOf((i | ((b & 63) << 8)) + 1), Integer.valueOf((((((byte) is.read()) & 15) << 10) | ((((byte) is.read()) & 255) << 2) | ((b & 192) >> 6)) + 1));
    }
    ...
    private static int getInt(InputStream is) throws IOException {
        ...
        return ((((byte) is.read()) << 24) & (-16777216)) | ((((byte) is.read()) << 16) & 16711680) | ((b2 << 8) & 65280) | (b & 255);
    }
    ...
    private static int read3Bytes(InputStream is) throws IOException {
        byte b = getByte(is);
        return ((getByte(is) << 16) & 16711680) | ((getByte(is) << 8) & 65280) | (b & 255);
    }

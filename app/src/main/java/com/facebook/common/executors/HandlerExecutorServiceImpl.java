...
public class HandlerExecutorServiceImpl extends AbstractExecutorService implements HandlerExecutorService {
    ...
    public <T> ScheduledFuture<T> submit(Runnable task, @Nullable T result) {
        task.getClass();
        ScheduledFutureImpl<T> scheduledFutureImplNewTaskFor = newTaskFor(task, (Runnable) result);
    ...
    public ScheduledFuture<?> schedule(Runnable command, long delay, TimeUnit unit) {
        ScheduledFutureImpl scheduledFutureImplNewTaskFor = newTaskFor(command, (Runnable) null);

...
final class Hpack {
    ...
    static final class Reader {
        ...
        void readHeaders() throws IOException {
            while (!this.source.exhausted()) {
                ...
                } else if ((b & HebrewProber.SPACE) == 32) {
                    int i2 = readInt(i, 31);
    ...
    static final class Writer {
        ...
        */
        void writeHeaders(java.util.List<dc.squareup.okhttp3.internal.http2.Header> r14) throws java.io.IOException {
            /*
                Method dump skipped, instructions count: 236
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: dc.squareup.okhttp3.internal.http2.Hpack.Writer.writeHeaders(java.util.List):void");
        }

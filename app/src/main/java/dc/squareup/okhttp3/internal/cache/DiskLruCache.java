...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final Runnable cleanupRunnable = new Runnable() { // from class: dc.squareup.okhttp3.internal.cache.DiskLruCache.1
    ...
    public final class Editor {
        ...
        public Sink newSink(int i) {
            synchronized (DiskLruCache.this) {
                ...
                try {
                    return new FaultHidingSink(DiskLruCache.this.fileSystem.sink(entry.dirtyFiles[i])) { // from class: dc.squareup.okhttp3.internal.cache.DiskLruCache.Editor.1
                        @Override // dc.squareup.okhttp3.internal.cache.FaultHidingSink
    ...
    private BufferedSink newJournalWriter() throws FileNotFoundException {
        return Okio.buffer(new FaultHidingSink(this.fileSystem.appendingSink(this.journalFile)) { // from class: dc.squareup.okhttp3.internal.cache.DiskLruCache.2
            static final /* synthetic */ boolean $assertionsDisabled = false;
    ...
    public synchronized Iterator<Snapshot> snapshots() throws IOException {
        initialize();
        return new Iterator<Snapshot>() { // from class: dc.squareup.okhttp3.internal.cache.DiskLruCache.3

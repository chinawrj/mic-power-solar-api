...
public final class CallServerInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (AbsoluteConst.EVENTS_CLOSE.equalsIgnoreCase(responseBuild2.request().header("Connection")) || AbsoluteConst.EVENTS_CLOSE.equalsIgnoreCase(responseBuild2.header("Connection"))) {
            streamAllocation.noNewStreams();
        }

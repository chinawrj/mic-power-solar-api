...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    */
    public void connect(int r17, int r18, int r19, int r20, boolean r21, dc.squareup.okhttp3.Call r22, dc.squareup.okhttp3.EventListener r23) throws java.lang.Throwable {
        /*
            Method dump skipped, instructions count: 341
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: dc.squareup.okhttp3.internal.connection.RealConnection.connect(int, int, int, int, boolean, dc.squareup.okhttp3.Call, dc.squareup.okhttp3.EventListener):void");
    }

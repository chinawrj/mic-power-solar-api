...
public final class HttpUrl {
                ...
                while (true) {
                    ...
                    if (cCharAt == '@') {
                        if (z) {
                            ...
                            int iDelimiterOffset2 = Util.delimiterOffset(str, i2, iDelimiterOffset, Operators.CONDITION_IF_MIDDLE);
                            i = iDelimiterOffset;
    ...
    */
    static void percentDecode(dc.squareup.okio.Buffer r5, java.lang.String r6, int r7, int r8, boolean r9) {
        /*
        L0:
            if (r7 >= r8) goto L42
            ...
            int r2 = dc.squareup.okhttp3.internal.Util.decodeHexDigit(r2)
            char r3 = r6.charAt(r1)
            int r3 = dc.squareup.okhttp3.internal.Util.decodeHexDigit(r3)
            r4 = -1
            if (r2 == r4) goto L39
            if (r3 == r4) goto L39
            int r7 = r2 << 4
        ...
        L42:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: dc.squareup.okhttp3.HttpUrl.percentDecode(dc.squareup.okio.Buffer, java.lang.String, int, int, boolean):void");
    }

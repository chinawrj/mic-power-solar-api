...
public abstract class UnsafeAllocator {
    ...
    public static UnsafeAllocator create() throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, ClassNotFoundException, SecurityException, IllegalArgumentException {
        try {
            ...
            return new UnsafeAllocator() { // from class: io.dcloud.uts.gson.internal.UnsafeAllocator.1
                @Override // io.dcloud.uts.gson.internal.UnsafeAllocator
            ...
            try {
                try {
                    ...
                    return new UnsafeAllocator() { // from class: io.dcloud.uts.gson.internal.UnsafeAllocator.2
                        @Override // io.dcloud.uts.gson.internal.UnsafeAllocator
                        public <T> T newInstance(Class<T> cls2) throws Exception {
                            assertInstantiable(cls2);
                    ...
                    return new UnsafeAllocator() { // from class: io.dcloud.uts.gson.internal.UnsafeAllocator.3
                        @Override // io.dcloud.uts.gson.internal.UnsafeAllocator
                        public <T> T newInstance(Class<T> cls2) throws Exception {
                            assertInstantiable(cls2);
                ...
                return new UnsafeAllocator() { // from class: io.dcloud.uts.gson.internal.UnsafeAllocator.4
                    @Override // io.dcloud.uts.gson.internal.UnsafeAllocator

...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new Comparator<Comparable>() { // from class: io.dcloud.uts.gson.internal.LinkedTreeMap.1
    ...
    class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public Iterator<Map.Entry<K, V>> iterator() {
            return new LinkedTreeMap<K, V>.LinkedTreeMapIterator<Map.Entry<K, V>>() { // from class: io.dcloud.uts.gson.internal.LinkedTreeMap.EntrySet.1
                {
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        public Iterator<K> iterator() {
            return new LinkedTreeMap<K, V>.LinkedTreeMapIterator<K>() { // from class: io.dcloud.uts.gson.internal.LinkedTreeMap.KeySet.1
                {
                    LinkedTreeMap linkedTreeMap = LinkedTreeMap.this;
                }

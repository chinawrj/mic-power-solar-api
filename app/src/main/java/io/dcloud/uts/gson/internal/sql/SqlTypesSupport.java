...
import io.dcloud.uts.gson.internal.bind.DefaultDateTypeAdapter;
...
public final class SqlTypesSupport {
    ...
    static {
        ...
        if (z) {
            DATE_DATE_TYPE = new DefaultDateTypeAdapter.DateType<java.sql.Date>(java.sql.Date.class) { // from class: io.dcloud.uts.gson.internal.sql.SqlTypesSupport.1
            ...
            TIMESTAMP_DATE_TYPE = new DefaultDateTypeAdapter.DateType<Timestamp>(Timestamp.class) { // from class: io.dcloud.uts.gson.internal.sql.SqlTypesSupport.2
                /* JADX INFO: Access modifiers changed from: protected */
                @Override // io.dcloud.uts.gson.internal.bind.DefaultDateTypeAdapter.DateType

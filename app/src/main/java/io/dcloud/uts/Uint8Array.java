...
public class Uint8Array extends TypedArray {
    ...
    /* compiled from: Uint8Array.kt */
    @Metadata(d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u001e\n\u0002\u0010\u0004\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J2\u0010\u0005\u001a\u00020\u00062\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\t0\b2\u001c\b\u0002\u0010\n\u001a\u0016\u0012\u0004\u0012\u00020\t\u0012\u0004\u0012\u00020\t\u0012\u0004\u0012\u00020\t\u0018\u00010\u000bJ\u001f\u0010\f\u001a\u00020\u00062\u0012\u0010\r\u001a\n\u0012\u0006\b\u0001\u0012\u00020\t0\u000e\"\u00020\t¢\u0006\u0002\u0010\u000fR\u000e\u0010\u0003\u001a\u00020\u0004X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u0010"}, d2 = {"Lio/dcloud/uts/Uint8Array$Companion;", "", "()V", "BYTES_PER_ELEMENT", "", "from", "Lio/dcloud/uts/Uint8Array;", "arrayLike", "", "", "mapFn", "Lkotlin/Function2;", "of", "items", "", "([Ljava/lang/Number;)Lio/dcloud/uts/Uint8Array;", "utsplugin_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    public static final class Companion {
        ...
        public final Uint8Array of(Number... items) {
            Intrinsics.checkNotNullParameter(items, "items");
            Uint8Array uint8Array = new Uint8Array(Integer.valueOf(items.length));
            ArrayList arrayList = new ArrayList(items.length);
            for (Number number : items) {
                TypedArray.putAuto$default(uint8Array, null, Byte.valueOf(number.byteValue()), 1, null);
        ...
        public static /* synthetic */ Uint8Array from$default(Companion companion, Collection collection, Function2 function2, int i, java.lang.Object obj) {
            if ((i & 2) != 0) {
                function2 = null;
            }
        ...
        public final Uint8Array from(Collection<? extends Number> arrayLike, Function2<? super Number, ? super Number, ? extends Number> mapFn) {
            Intrinsics.checkNotNullParameter(arrayLike, "arrayLike");
            Uint8Array uint8Array = new Uint8Array(Integer.valueOf(arrayLike.size()));
            int i = 0;
            for (Number number : arrayLike) {
                if (mapFn != null) {
                    TypedArray.putAuto$default(uint8Array, null, Byte.valueOf(mapFn.invoke(number, Integer.valueOf(i)).byteValue()), 1, null);
                } else {
                    TypedArray.putAuto$default(uint8Array, null, Byte.valueOf(number.byteValue()), 1, null);
                }
                i++;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Uint8Array(Collection<? extends Number> array) {
        super(array);
    ...
    public /* synthetic */ Uint8Array(ArrayBuffer arrayBuffer, Number number, Number number2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(arrayBuffer, (i & 2) != 0 ? null : number, (i & 4) != 0 ? null : number2);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Uint8Array(ArrayBuffer buffer, Number number, Number number2) {
    ...
    @Override // io.dcloud.uts.TypedArray
    public <T extends TypedArray> Uint8Array filter(Function3<? super Number, ? super Number, ? super T, Boolean> predicate) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of io.dcloud.uts.Uint8Array.filter");
            if (predicate.invoke(numValueOf, numValueOf2, this).booleanValue()) {
                uTSArray.add(Integer.valueOf(auto.intValue()));
            }
        }
        return new Uint8Array(uTSArray);
    }
    ...
    @Override // io.dcloud.uts.TypedArray
    public <T extends TypedArray> Uint8Array map(Function3<? super Number, ? super Number, ? super T, ? extends Number> callbackfn) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of io.dcloud.uts.Uint8Array.map");
    ...
    public Number getAuto(int index) {
        return Integer.valueOf(UByte.m344constructorimpl(getByteBuffer().get(index)) & 255);
    }

    @Override // io.dcloud.uts.TypedArray
    public Uint8Array slice(Number start, Number end) {
        if (start == null) {
            start = (Number) 0;
        }
        if (end == null) {
    ...
    */
    public io.dcloud.uts.Uint8Array subarray(java.lang.Number r5, java.lang.Number r6) {
        /*
            r4 = this;
            r0 = 0
        ...
        L5a:
            ...
            goto L5a
        L6b:
            io.dcloud.uts.Uint8Array r5 = new io.dcloud.uts.Uint8Array
            java.util.Collection r1 = (java.util.Collection) r1
            r5.<init>(r1)
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: io.dcloud.uts.Uint8Array.subarray(java.lang.Number, java.lang.Number):io.dcloud.uts.Uint8Array");
    }
    ...
    /* compiled from: Uint8Array.kt */
    @Metadata(d1 = {"\u0000\u0017\n\u0000\n\u0002\u0010(\n\u0002\u0010\u0004\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001J\t\u0010\u0003\u001a\u00020\u0004H\u0096\u0002J\t\u0010\u0005\u001a\u00020\u0002H\u0096\u0002¨\u0006\u0006"}, d2 = {"io/dcloud/uts/Uint8Array$iterator$1", "", "", "hasNext", "", "next", "utsplugin_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    /* renamed from: io.dcloud.uts.Uint8Array$iterator$1, reason: invalid class name */
    public static final class AnonymousClass1 implements Iterator<Number>, KMappedMarker {
        ...
        public boolean hasNext() {
            return Uint8Array.this.getByteBuffer().remaining() > 0;
        }
        ...
        public Number next() {
            ...
            return Integer.valueOf(UByte.m344constructorimpl(Uint8Array.this.getByteBuffer().get()) & 255);
        }
    }
}

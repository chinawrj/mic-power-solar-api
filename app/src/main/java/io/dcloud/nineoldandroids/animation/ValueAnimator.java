...
public class ValueAnimator extends Animator {
    ...
    @Override // io.dcloud.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public ValueAnimator m282clone() {
        ValueAnimator valueAnimator = (ValueAnimator) super.m282clone();
        ArrayList<AnimatorUpdateListener> arrayList = this.mUpdateListeners;
        if (arrayList != null) {
        ...
        if (propertyValuesHolderArr != null) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                PropertyValuesHolder propertyValuesHolderM286clone = propertyValuesHolderArr[i2].m286clone();
                valueAnimator.mValues[i2] = propertyValuesHolderM286clone;
                valueAnimator.mValuesMap.put(propertyValuesHolderM286clone.getPropertyName(), propertyValuesHolderM286clone);
            }
        }
        return valueAnimator;
    }

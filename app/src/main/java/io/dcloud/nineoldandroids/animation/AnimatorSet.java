...
public final class AnimatorSet extends Animator {
    ...
    public void start() {
        ...
        if (this.mStartDelay <= 0) {
            ...
            this.mDelayAnim.addListener(new AnimatorListenerAdapter() { // from class: io.dcloud.nineoldandroids.animation.AnimatorSet.1
    ...
    @Override // io.dcloud.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public AnimatorSet m282clone() {
        AnimatorSet animatorSet = (AnimatorSet) super.m282clone();
        ...
        while (it.hasNext()) {
            Node next = it.next();
            Node nodeM283clone = next.m283clone();
            map.put(next, nodeM283clone);
            animatorSet.mNodes.add(nodeM283clone);
            animatorSet.mNodeMap.put(nodeM283clone.animation, nodeM283clone);
            ArrayList arrayList = null;
            nodeM283clone.dependencies = null;
            nodeM283clone.tmpDependencies = null;
            nodeM283clone.nodeDependents = null;
            nodeM283clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = nodeM283clone.animation.getListeners();
            if (listeners != null) {
    ...
    private static class Node implements Cloneable {
        ...
        public Node m283clone() {
            try {
                Node node = (Node) super.clone();
                node.animation = this.animation.m282clone();
                return node;

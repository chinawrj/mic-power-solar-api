...
class FloatKeyframeSet extends KeyframeSet {
    ...
    @Override // io.dcloud.nineoldandroids.animation.KeyframeSet
    ...
    @Override // io.dcloud.nineoldandroids.animation.KeyframeSet
    /* renamed from: clone */
    public FloatKeyframeSet m285clone() {
        ArrayList<Keyframe> arrayList = this.mKeyframes;
        int size = this.mKeyframes.size();
        Keyframe.FloatKeyframe[] floatKeyframeArr = new Keyframe.FloatKeyframe[size];
        for (int i = 0; i < size; i++) {
            floatKeyframeArr[i] = (Keyframe.FloatKeyframe) arrayList.get(i).m284clone();
        }
